...
<head>
    ...
    <link rel="stylesheet" href="{{ url('css/styles/adminSH/styles.css') }}">
    <title>Dwell</title>
    <style>
        body {
                ...
                <div class="container-fluid mx-auto px-2">
                    <div class="flex items-center justify-between py-2 relative">
                        <div class="flex items-center w-full lg:w-auto">
                            <a class="navbar-brand" href="{{url('adminSH/')}}">
...
<script src="{{ url('js/adminSH/logout.js') }}"></script>
<script src="{{ url('js/adminSH/pre-booking/functions.js') }}"></script>
<script src="{{ url('js/adminSH/booking-guesthouse/functions.js') }}"></script>
<script src="{{ url('js/adminSH/booking-staffhouse/functions.js') }}"></script>
<script src="{{ url('js/adminSH/booking-dftc/functions.js') }}"></script>
<script src="{{ url('js/adminSH/booking-dftchall/functions.js') }}"></script>
<script src="{{ url('js/adminSH/room/functions.js') }}"></script>
<script src="{{ url('js/adminSH/staffhouse/functions.js') }}"></script>
<script src="{{ url('js/adminSH/my-guesthouse/functions.js') }}"></script>
<script src="{{ url('js/adminSH/my-staffhouse/functions.js') }}"></script>
<script src="{{ url('js/adminSH/my-dftc-room/functions.js') }}"></script>
<script src="{{ url('js/adminSH/my-dftc-hall/functions.js') }}"></script>
<script src="{{ url('js/adminSH/pdf-form/functions.js') }}"></script>
<script src="{{ url('js/adminSH/account/functions.js') }}"></script>
<script src="{{ url('js/adminSH/data-tables/functions.js') }}"></script>
