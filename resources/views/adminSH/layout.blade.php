...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/css/styles/adminSH/styles.css') }}">
    <title>Dwell</title>
    <style>
        body {
                ...
                <div class="container-fluid mx-auto px-2">
                    <div class="flex items-center justify-between py-2 relative">
                        ...
                        <div class="hidden lg:flex lg:items-center lg:w-auto lg:space-x-6" id="top-navbar">
                            <ul class="flex flex-col lg:flex-row space-x-0 lg:space-x-2 list-none lg:ml-auto" id="navLinks">
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('adminSH/view-home') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-home') }}">HOME</a>
                                </li>
                                <li class="lg:hidden"><hr class="dropdown-divider"></li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('adminSH/view-guesthouse-rooms') || Request::is('adminSH/view-staffhouse-rooms') || Request::is('adminSH/view-DFTC-rooms') || Request::is('adminSH/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-staffhouse-rooms') }}">ROOMS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('adminSH/view-guesthouse-pre-reservation-form') || Request::is('adminSH/view-staffhouse-pre-reservation-form') || Request::is('adminSH/view-DFTC-room-pre-reservation-form') || Request::is('adminSH/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-staffhouse-pre-reservation-form') }}">PRE-BOOK NOW</a>
                                </li>
                                <li class="nav-item">
                                    <button id="signOutButton" class="btn btn-nav Montserrat inactive">LOGOUT</button>
                                </li>
                            </ul>
                        </div>
                        <!-- User greetings on the right (outside toggle button)-->
                        <div class="hidden lg:flex lg:items-center text-end">
                            <a class="navbar-brand text-light-green Montserrat icon lg:text-lg font-medium hover:text-dark-green transition ease-in-out duration-500" href="{{ url('adminSH/view-dashboard') }}">Hi, {{ session('loggedInAdminSH')['fullname'] }}<i class="fas fa-user fa-xl icon" style="color: #1abc02;"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="lg:hidden fixed top-0 right-0 bg-gradient-to-r from-light-white via-lightest-green to-lightest-green p-4 shadow-lg drop-shadow-lg rounded-bl-lg" id="mobileMenu" style="display: none;">
                        ...
                        <div class="flex flex-col flex-wrap px-2 mt-10">
                            <a class="navbar-brand text-light-green Montserrat icon text-lg font-medium hover:text-dark-green transition ease-in-out duration-500 mb-4 inline-block max-w-xs break-normal align-middle" href="{{ url('adminSH/view-dashboard') }}">
                                Hi, {{ session('loggedInAdminSH')['fullname'] }}!
                            </a>
                            <ul class="flex flex-col justify-center text-center space-y-2 list-none w-full">
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('adminSH/view-home') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-home') }}" style="width:100%;">HOME</a>
                                </li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('adminSH/view-guesthouse-rooms') || Request::is('adminSH/view-staffhouse-rooms') || Request::is('adminSH/view-DFTC-rooms') || Request::is('adminSH/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-staffhouse-rooms') }}" style="width:100%;">ROOMS</a>
                                </li>
                                <li><hr class="dropdown-divider bg-dark-green" style="height: 1px;"></li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('adminSH/view-guesthouse-pre-reservation-form') || Request::is('adminSH/view-staffhouse-pre-reservation-form') || Request::is('adminSH/view-DFTC-room-pre-reservation-form') || Request::is('adminSH/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-staffhouse-pre-reservation-form') }}" style="width:100%;">PRE-BOOK NOW</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="container" data-aos="fade-right" data-aos-duration="800">
                <div class="row text-dark-white text-left">
                    <div class="col-md-4 mb-6 md:mb-0">
                        ...
                        <p class="text-xs Montserrat footerText h-3">&copy; 2024 Dwell.</p>
                        ...
                        <div class="carousel-item" style="background-color: #f5f5f5">
                            <div class="text-center">
                                ...
                                <div class="d-flex justify-content-center mt-3">
                                    ...
                                    <a href="https://www.instagram.com/arrrrrrj_/" target="_blank"  class="mx-2">
                                        <img src="{{ asset('/public/images/ig.svg') }}" class="social-icon ig-icon" alt="Instagram">
                                    </a>
                                </div>
                            </div>
...
<script src="{{ url('public/js/adminSH/logout.js') }}"></script>
<script src="{{ url('public/js/adminSH/pre-booking/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/booking-guesthouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/booking-staffhouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/booking-dftc/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/booking-dftchall/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/room/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/staffhouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/my-guesthouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/my-staffhouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/my-dftc-room/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/my-dftc-hall/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/pdf-form/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/account/functions.js') }}"></script>
<script src="{{ url('public/js/adminSH/data-tables/functions.js') }}"></script>
