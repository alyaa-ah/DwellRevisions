...
<div class="outer-container">
    <div class="container flex-column d-flex justify-content-center align-items-center">
        ...
        <div class="row justify-content-center"data-aos="fade-up" data-aos-duration="800">
            <div class="col-md-12 mt-2">
                <div class="col-md-12">
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminSH/view-DFTC-room-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-DFTC-room-pre-reservation-form') }}">Room</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminSH/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-DFTC-hall-pre-reservation-form') }}">Hall</a>
                </div>
            </div>
        </div>
        <div class="row justify-content-center" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="rate" id="rateHallDftc" style="background-color:#d3d3d3;" placeholder="0.00" value="{{ isset($data['room_rate']) ? $data['room_rate'] : '' }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    <label for="capacity" class="Montserrat text-sm font-semibold">Max Capacity</label>
                                    <input type="text" class="form-control" name="capacity" id="capacityHallDftc" style="background-color:#d3d3d3;" placeholder="0" value="{{ isset($data['room_capacity']) ? $data['room_capacity'] : '' }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    <label for="totalAmount" class="Montserrat text-sm font-semibold">Total Amount</label><br>
                                    <input type="text" class="form-control" name="totalAmount" id="totalAmountHallDftc" style="background-color:#d3d3d3;" placeholder="0.00" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group text-sm text-light-green">
                                            ...
                                            <input type="number" name="janitorservices" id="janitorservices" style="background-color:#d3d3d3;" placeholder="0.00" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group text-light-green">
                                            <label for="extracharge" class="Montserrat text-sm font-semibold">Exceed 8 hrs Extra Charge</label>
                                            <input type="number" name="extracharge" id="extracharge" class="form-control" style="background-color:#d3d3d3;" placeholder="0.00" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group text-sm text-light-green">
                                            ...
                                            <input type="number" name="avservices" id="avservices" class="form-control" style="background-color:#d3d3d3;" placeholder="0.00" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group text-sm text-light-green">
                                            <label for="timerate" class="Montserrat text-sm font-semibold">Night Time Rate</label>
                                            <input type="number" name="timerate" id="timerate" class="form-control" style="background-color:#d3d3d3;" placeholder="0.00" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
