        ...
        <div class="row align-items-center m-1" data-aos="fade-up" data-aos-duration="800">
            <div class="col-md-12 text-center">
                ...
                <div class="button-group d-none d-md-flex">
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminSH/view-guesthouse-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right: 5px;" href="{{ url('/adminSH/view-guesthouse-pre-reservation-form') }}">Guest House</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminSH/view-staffhouse-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right: 5px;" href="{{ url('/adminSH/view-staffhouse-pre-reservation-form') }}">Staff House</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminSH/view-DFTC-room-pre-reservation-form') || Request::is('adminSH/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right: 5px;" href="{{ url('/adminSH/view-DFTC-room-pre-reservation-form') }}">DFTC</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 mt-2">
                ...
                <div class="select-group d-md-none">
                    <select class="form-select h-9 Montserrat bg-light-green text-dark-white w-100" style="width:100%;" onchange="location = this.value;">
                        <option class="{{ Request::is('adminSH/view-guesthouse-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminSH/view-guesthouse-pre-reservation-form') }}" {{ Request::is('adminSH/view-guesthouse-pre-reservation-form') ? 'selected' : '' }}>Guest House</option>
                        <option class="{{ Request::is('adminSH/view-staffhouse-pre-reservation-forms') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminSH/view-staffhouse-pre-reservation-form') }}" {{ Request::is('adminSH/view-staffhouse-pre-reservation-form') ? 'selected' : '' }}>Staff House</option>
                        <option class="{{ Request::is('adminSH/view-DFTC-room-pre-reservation-form') || Request::is('adminSH/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminSH/view-DFTC-room-pre-reservation-form') }}" {{ Request::is('adminSH/view-DFTC-room-pre-reservation-form') || Request::is('adminSH/view-DFTC-hall-pre-reservation-form') ? 'selected' : '' }}>DFTC</option>
                    </select>
                </div>
            </div>
        </div>
                ...
                <div class="container mx-auto mt-2">
                    <div class="border-2 rounded-md border-green-500 p-1 m-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    ...
                                    <select name="position" id="positionStaffHouse" class="form-control @if(isset($user['position'])) readonly-select @endif" @if(isset($user['position'])) readonly required @endif>
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="email" id="emailStaffHouse" placeholder="Please insert your gmail address here." value="{{ isset($user['email']) ? $user['email'] : '' }}" @if(isset($user['email'])) readonly required @endif>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2" id="letterInputCellStaffHouse" style="display: none;">
                            <div class="col-12">
                                <div class="form-group text-light-green">
                                    <label for="hasLetter" class="Montserrat text-sm font-semibold">Please attach the letter approved by the President or the Campus Administrator to avail of free services (exclusive to students only).</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group text-light-green">
                                            ...
                                            <input type="time" class="form-control" name="arrival" id="arrivalStaffHouse" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="form-group text-light-green">
                                            ...
                                            <input type="time" class="form-control" name="departure" id="departureStaffHouse" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group text-light-green">
                                                ...
                                                <textarea name="maleGuests" id="maleGuestsStaffHouse" cols="5" rows="5" class="form-control" placeholder="Note: For every name, please include a comma in between and enter the name(s) of male guest(s), including yourself if necessary." disabled></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group text-light-green">
                                                <label for="femaleGuests" class="Montserrat text-sm font-semibold">Name of Guest/s (Female)</label>
                                                <textarea name="femaleGuests" id="femaleGuestsStaffHouse" cols="5" rows="5" class="form-control" placeholder="Note: For every name, please include a comma in between and enter the name(s) of female guest(s), including yourself if necessary." disabled></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light-green">
                <div class="container">
                    ...
                    <button type="button" id="submitButton1" class="btn bg-medium-green text-white hover:bg-dark-green Montserrat">Submit</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    document.getElementById('numOfMaleStaffHouse').addEventListener('input', function() {
        var maleGuestField = document.getElementById('maleGuestsStaffHouse');
        maleGuestField.disabled = this.value <= 0;
    });

    document.getElementById('numOfFemaleStaffHouse').addEventListener('input', function() {
        var femaleGuestField = document.getElementById('femaleGuestsStaffHouse');
        femaleGuestField.disabled = this.value <= 0;
    });
</script>
<script src="{{ url('public/js/adminSH/booking-staffhouse/payment.js') }}"></script>
@endsection
