        ...
        <div class="col-9 col-md-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 d-flex justify-content-center mt-2">
                    ...
                    <div class="button-group d-none d-md-flex">
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminSH/view-my-guesthouse-canceled-pre-reservations') || Request::is('adminSH/view-my-guesthouse-rejected-pre-reservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-my-guesthouse-canceled-pre-reservations') }}">Guest House</a>
                        ...
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminSH/view-my-DFTC-canceled-pre-reservations') || Request::is('adminSH/view-my-DFTC-rejected-pre-reservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-my-DFTC-canceled-pre-reservations') }}">DFTC</a>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-12 mt-2">
                    ...
                    <div class="select-group d-md-none">
                        <select class="form-select h-9 Montserrat bg-light-green text-dark-white sm:my-2 sm:w-full md:w-auto" onchange="location = this.value;">
                            <option class="{{ Request::is('adminSH/view-my-guesthouse-canceled-pre-reservations*') || Request::is('adminSH/view-my-guesthouse-rejected-pre-reservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminSH/view-my-guesthouse-canceled-pre-reservations') }}" {{ Request::is('adminSH/view-my-guesthouse-canceled-pre-reservations*') || Request::is('adminSH/view-my-guesthouse-rejected-pre-reservations*') ? 'selected' : '' }}>Guest House</option>
                            <option class="{{ Request::is('adminSH/view-my-staffhouse-canceled-pre-reservations*') || Request::is('adminSH/view-my-staffhouse-rejected-pre-reservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminSH/view-my-staffhouse-canceled-pre-reservations') }}" {{ Request::is('adminSH/view-my-staffhouse-canceled-pre-reservations*') || Request::is('adminSH/view-my-staffhouse-rejected-pre-reservations*') ? 'selected' : '' }}>Staff House</option>
                            <option class="{{ Request::is('adminSH/view-my-DFTC-canceled-pre-reservations*') || Request::is('adminSH/view-my-DFTC-rejected-pre-reservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminSH/view-my-DFTC-canceled-pre-reservations') }}" {{ Request::is('adminSH/view-my-DFTC-canceled-pre-reservations*') || Request::is('adminSH/view-my-DFTC-rejected-pre-reservations*') ? 'selected' : '' }}>DFTC</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 d-flex justify-content-center" style="margin-top: 1rem;">
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminSH/view-my-guesthouse-canceled-pre-reservations') || Request::is('adminSH/view-my-staffhouse-canceled-pre-reservations') || Request::is('adminSH/view-my-DFTC-canceled-pre-reservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-my-staffhouse-canceled-pre-reservations') }}">Canceled</a>
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminSH/view-my-guesthouse-rejected-pre-reservations') || Request::is('adminSH/view-my-staffhouse-rejected-pre-reservations') || Request::is('adminSH/view-my-DFTC-rejected-pre-reservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminSH/view-my-staffhouse-rejected-pre-reservations') }}">Rejected</a>
                </div>
            </div>
            ...
            <div class="container card w-100 bg-light-white mt-2">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-responsive table-striped table-hover w-auto" id="myStaffHouseRejectedTableAdminSH">
                            <thead>
