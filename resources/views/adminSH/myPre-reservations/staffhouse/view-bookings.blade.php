    ...
    <div class="row">
        ...
        <div class="col-9 col-md-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="container card w-12/12 bg-light-white mt-2">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-responsive table-striped table-hover w-auto" id="myStaffHouseBookingTableAdminSH">
                            <thead>
                                ...
                                @foreach ($bookings as $booking)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" onclick="editStaffHouseBookingAdminSH('{{ addslashes(json_encode($booking) )}}')" class="btn btn-warning"><i class="fa-solid fa-edit" style="color: black;"></i></button>
                                                @if ($booking->status == 'Pending Review')

                                                @else
                                                    <button type="button" onclick="generateAdminSHPdfStaffHouseBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-success"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></button>
                                                @endif
                                            <button type="button" onclick="cancelStaffHouseBookingAdminSH('{{ addslashes(json_encode($booking)) }}')" class="btn btn-danger"><i class="fa-solid fa-xmark" style="color: #000000;"></i></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                        ...
                        <form id="edit-staffHouse-booking-form">
                                ...
                                <div class="container mx-auto mt-2">
                                    <div class="border-2 rounded-md border-green-500 p-1 m-2">
                                        ...
                                        <div class="row mb-2" id="editLetterInputCellStaffHouse" style="display: none;">
                                            <div class="col-12">
...
<script src="{{ url('public/js/adminSH/my-staffhouse/payment.js') }}"></script>
@endsection
