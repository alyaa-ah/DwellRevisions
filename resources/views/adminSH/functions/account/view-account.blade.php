                ...
                <div class="card w-full bg-light-white mt-2 px-1">
                    <div class="row">
                        <div class="col-md-12 mt-2 mb-2">
                            <table class="table table-responsive table-striped table-hover w-auto" id="accountTableAdminSH">
                                <thead>
                                    <tr>
                                    ...
                                    @foreach ($clients as $client)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button onclick="viewAccountAdminSH('{{ addslashes(json_encode($client)) }}')" type="button" class="btn btn-info" title="View Button"><i class="fa-solid fa-eye" style="color: BLACK;"></i></button>
                                                <button onclick="editAccountAdminSH('{{ addslashes(json_encode($client)) }}')" type="button" class="btn btn-warning" title="Edit Button"><i class="fa-solid fa-edit" style="color: #000000;"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                        ...
                                        <input type="text" class="form-control" name="fullname" style="background-color:#d3d3d3;" readonly id="edit-fullname-account">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group Montserrat text-sm font-semibold text-light-green">
