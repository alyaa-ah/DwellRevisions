                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="fullname" id="fullName" placeholder="Please insert your full name here."  style="background-color:#d3d3d3;"  value="{{ isset($user['fullname']) ? $user['fullname'] : session('loggedInCustomer')['fullname'] }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    <label class="Montserrat text-sm font-semibold">Position/Designation <span class="text-red-600">*</span></label>
                                        ...
                                        @endphp
                                        <select name="position" id="position" class="form-control @if($isReadonly) readonly-select @endif"  style="background-color:#d3d3d3;" @if($isReadonly) readonly @endif>
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="address" style="background-color:#d3d3d3;" id="address" placeholder="Please insert your home address here." value="{{ isset($user['address']) ? $user['address'] : session('loggedInCustomer')['address'] }}"  readonly required>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    <label for="agency" class="Montserrat text-sm font-semibold">Department/Agency/College <span class="text-red-600">*</span></label>
                                    <input type="text" class="form-control" name="agency" style="background-color:#d3d3d3;" id="agency" placeholder="Please insert your institution here." value="{{ isset($user['agency']) ? $user['agency'] : session('loggedInCustomer')['agency'] }}" readonly required>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    <label for="contactNumber" class="Montserrat text-sm font-semibold">Contact Number <span class="text-red-600">*</span></label>
                                    <input type="text" class="form-control" name="contactnumber" style="background-color:#d3d3d3;" id="contactNumber" placeholder="Please insert your contact number here." value="{{ isset($user['contact']) ? $user['contact'] : session('loggedInCustomer')['contact'] }}" readonly required>
                                </div>
                            </div>
                            <div class="row mb-2" id="letterInputCell" style="display: none;">
                                <div class="col-12">
                                    <div class="form-group text-light-green">
                            ...
                            <div class="col-md-4">
                                <div class="row mb-1">
                                    <div class="form-group text-light-green">
                                        ...
                                        <select name="room_number" id="room_number" class="form-control"@if(isset($data['id'])) readonly @endif>
                                            @if (isset($data['id']))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="capacity" id="capacity" style="background-color:#d3d3d3;" placeholder="0"  value="{{ isset($data['room_capacity']) ? $data['room_capacity'] : '' }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
