                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group text-light-green">
                                    ...
                                    @endphp
                                    <select name="position" id="positionHallDftc" class="form-control @if($isReadonly) readonly-select @endif" style="background-color:#d3d3d3;" @if($isReadonly) readonly @endif>
