        ...
        <div class="col-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 mt-2">
                    ...
                    <div class="select-group d-md-none">
                        <select class="form-select h-9 Montserrat bg-light-green text-dark-white sm:my-2 sm:w-full md:w-auto" onchange="location = this.value;">
                            <option class="{{ Request::is('client/view-guesthouse-prereservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-guesthouse-prereservations') }}" {{ Request::is('client/view-guesthouse-prereservations*') ? 'selected' : '' }}>Guest House</option>
                            <option class="{{ Request::is('client/view-staffhouse-prereservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-staffhouse-prereservations') }}" {{ Request::is('client/view-staffhouse-prereservations*') ? 'selected' : '' }}>Staff House</option>
                ...
                <p class="Montserrat text-2xl md:text-5xl font-extrabold textGradient text-center mt-3">
                    <span class="hidden sm:inline">DUMLAO FARMERS' TRAINING CENTER</span>
                    <span class="sm:hidden">DFTC</span>
                </p>
                <div class="container card w-100 bg-light-white mt-2">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-responsive table-striped table-hover w-auto" id="dftcClientTable">
                                <thead>
                                    <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($booking->room_type == "Hall")
                                                        <button type="button" onclick="viewClientDftcHallBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-info"><i class="fa-solid fa-eye" style="color: BLACK;" title="View Button for hall"></i></button>
                                                            ...
                                                            @endif
                                                    @else
                                                        <button type="button" onclick="viewClientDftcRoomBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-info"><i class="fa-solid fa-eye" style="color: BLACK;" title="View Button for room"></i></button>
                                                            @if ($booking->status == "Pending Review")
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                            ...
                                                            <input type="time" class="form-control" name="departure" id="editDepartureDftcRoom" id="editDepartureGuestHouse" style="background-color:#d3d3d3;" readonly required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
        ...
        <div class="modal-content" >
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="edit-client-dftchall-booking-form">
                                @csrf
                                <div class="border-2 rounded-md border-green-500 p-1 m-2">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                        <label for="numOfFemale">Number of Female<span class="text-red-600">*</span></label>
                                                        <input type="number" class="form-control" name="numOfFemale" id="editNumOfFemalesDftcHall" placeholder="Enter here the estimated number of female guest." value="0" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="border-2 rounded-md border-green-500 p-1 m-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                <label for="rate">Rate</label>
                                                <input type="text" class="form-control" name="rate" id="editRateDftcHall" style="background-color:#d3d3d3;" placeholder="0.00" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                <label for="capacity">Max Capacity</label>
                                                <input type="text" class="form-control" name="capacity" id="editCapacityDftcHall" style="background-color:#d3d3d3;"  placeholder="0" readonly >
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                <label for="totalAmount" class="text-sm">Total Amount</label><br>
                                                <input type="text" class="form-control" name="totalAmount" id="editTotalAmountDftcHall" style="background-color:#d3d3d3;"  placeholder="0.00" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                             ...
                                             <div class="row">
                                                <div class="col-md-6 md-2">
                                                    <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                        ...
                                                        <input type="number" name="janitorservices" id="editJanitorialServicesDftcHall" class="form-control"  style="background-color:#d3d3d3;" placeholder="0.00" style="background-color:#d3d3d3;" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-2">
                                                    <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                        <label for="avservices">AV Services</label>
                                                        <input type="number" name="avservices" id="editAvServicesDftcHall" class="form-control"  style="background-color:#d3d3d3;" placeholder="0.00" style="background-color:#d3d3d3;" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
