...
<div class="container-fluid m-0 w-full justify-content-center align-items-center"  @if($countBookings <= 0 ) style="height: 100vh;" @else style="height: auto;" @endif >
    <div class="row">
        ...
        <div class="col-10 content m-2 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            <p class="Montserrat h-12 text-3xl font-extrabold textGradient" style="margin-top: 2rem">VOIDS</p>
            <div class="row justify-content-center">
                ...
                <div class="col-md-12 d-flex justify-content-center mt-1">
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('client/view-DFTC-canceled-preservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-DFTC-canceled-preservations') }}">Canceled</a>
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('client/view-DFTC-rejected-preservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-DFTC-rejected-preservations') }}">Rejected</a>
                </div>
                ...
                <div class="container card w-100 bg-light-white mt-2">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-responsive table-striped table-hover w-auto" id="rejectedDftcClient">
                                <thead>
                                    <tr>
