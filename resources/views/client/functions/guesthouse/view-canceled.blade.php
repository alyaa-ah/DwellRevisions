        ...
        <div class="col-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <div class="select-group d-md-none">
                            <select class="form-select h-9 Montserrat bg-light-green text-dark-white sm:-2 sm:w-full md:w-auto" onchange="location = this.value;">
                                <option class="{{ Request::is('client/view-guesthouse-canceled-preservations*') || Request::is('client/view-guesthouse-rejected-preservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-guesthouse-canceled-preservations') }}" {{ Request::is('client/view-guesthouse-canceled-prereservations*') || Request::is('client/view-guesthouse-rejected-prereservations*') ? 'selected' : '' }}>Guest House</option>
                                <option class="{{ Request::is('client/view-staffhouse-canceled-prereservations*') || Request::is('client/view-staffhouse-rejected-prereservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-staffhouse-canceled-prereservations') }}" {{ Request::is('client/view-staffhouse-canceled-prereservations*') || Request::is('client/view-staffhouse-rejected-prereservations*') ? 'selected' : '' }}>Staff House</option>
                                <option class="{{ Request::is('client/view-DFTC-canceled-prereservations*') || Request::is('client/view-DFTC-rejected-prereservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-DFTC-canceled-prereservations') }}" {{ Request::is('client/view-DFTC-canceled-prereservations*') || Request::is('client/view-DFTC-rejected-prereservations*') ? 'selected' : '' }}>DFTC</option>
                            </select>
                        </div>
                    </div>
                </div>
            <div class="row justify-content-center">
                <div class="col-md-12 d-flex justify-content-center  mt-1">
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('client/view-guesthouse-canceled-preservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-guesthouse-canceled-preservations') }}">Canceled</a>
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('client/view-guesthouse-rejected-preservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-guesthouse-rejected-preservations') }}">Rejected</a>
                </div>
            </div>
            ...
            <div class="container card w-100 bg-light-white mt-2">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-responsive table-striped table-hover w-auto" id="canceledGuestHouseClient">
                            <thead>
                                <tr>
