...
<div class="container-fluid m-0 w-full justify-content-center align-items-center" style="height: auto;">
    <div class="row">
            ...
            <div class="d-flex flex-column align-items-center text-white min-vh-100">
                <ul class="nav nav-pills flex-column mb-sm-auto align-items-center align-items-sm-start flex-column mt-5 mb-auto Montserrat font-semibold">
                    <li class="border-top border-bottom w-full mt-4">
                        <a href="{{ url('/client/view-dashboard') }}" class="nav-link text-white hover:bg-medium-green {{ Request::is('client/view-dashboard') || Request::is('client/view-dashboard-staffhouse') ? 'bg-dark-green text-dark-white' : '' }}">
        ...
        <div class="col-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-responsive table-striped table-hover w-auto" id="staffHouseHistoryRatingClientTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($staffHouseCurrentBookingsHistory as $booking)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($booking->ratings == "NULL" || $booking->ratings == "")
                                            <button type="button" onclick="makeRatingsStaffHouse('{{ addslashes(json_encode($booking)) }}')" class="btn btn-warning"><i class="fa-solid fa-star" style="color: BLACK;"></i></button>
                                        @else
                                            <button type="button" onclick="viewRatingsStaffHouse('{{ addslashes(json_encode($booking)) }}')" class="btn btn-info"><i class="fa-solid fa-eye" style="color: BLACK;"></i></button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
...
<div class="modal fade" id="rating-staffHouse-booking-modal">
        ...
        <div class="modal-content" >
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="rating-clientStaffHouse">
                                @csrf
                                <div class="mb-3">
                                    <input type="text" name="booking_id" id="client_rating_id_staffHouse" hidden>
                                </div>
                                <div class="mb-3">
...
<div class="modal fade" id="view-rating-staffHouse-booking-modal">
    <div class="modal-dialog modal-m">
        <div class="modal-content" >
            <div class="modal-header bg-light-green">
                    ...
                    <div class="row">
                        <div class="col-md-12 border-4 rounded-md border-green-600">
                            ...
                            <div class="row bg-gray-100  py-1 border-top border-bottom">
                                ...
                                <div class="col-md-10 ">
                                    <textarea class="form-control" id="feedbackStaffHouseModal" readonly cols="45" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
