            ...
            <div class="col-md-12 mt-2">
                ...
                <div class="select-group d-md-none">
                    <select class="form-select h-9 Montserrat bg-light-green text-dark-white w-100" style="width:100%;" onchange="location = this.value;">
                        ...
                        <option class="{{ Request::is('client/view-DFTC-rooms') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-DFTC-rooms') }}" {{ Request::is('client/view-DFTC-rooms') ? 'selected' : '' }}>DFTC</option>
                    </select>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td class="Montserrat text-light-green text-sm font-semibold">Inclusion: {{ $room->room_inclusion }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            @if($room->room_status != 'Unavailable' && $room->room_status != 'On-Renovation')
                                                <div class="d-flex justify-content-end">
                                                    <button type="button" id="dftc-booking"
                                                        onclick="bookDftc('{{ addslashes(json_encode($room)) }}', '{{ addslashes(json_encode(session('loggedClient'))) }}')"
