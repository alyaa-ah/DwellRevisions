...
<div class="outer-container">
    <div class="container flex-column d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-duration="800">
        <div class="row align-items-center m-1">
            <div class="col-md-12 text-center">
                ...
                <div class="button-group d-none d-md-flex">
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('client/view-guesthouse-rooms') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right: 5px;"href="{{ url('/client/view-guesthouse-rooms') }}">Guest House</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('client/view-staffhouse-rooms') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right: 5px;"href="{{ url('/client/view-staffhouse-rooms') }}">Staff House</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('client/view-DFTC-rooms') || Request::is('client/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-DFTC-rooms') }}">DFTC</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 mt-2">
                ...
                <div class="select-group d-md-none">
                    <select class="form-select h-9 Montserrat bg-light-green text-dark-white w-100" style="width:100%;" onchange="location = this.value;">
                        <option class="{{ Request::is('client/view-guesthouse-rooms') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-guesthouse-rooms') }}" {{ Request::is('client/view-guesthouse-rooms') ? 'selected' : '' }}>Guest House</option>
                        <option class="{{ Request::is('client/view-staffhouse-rooms') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-staffhouse-rooms') }}" {{ Request::is('client/view-staffhouse-rooms') ? 'selected' : '' }}>Staff House</option>
                        <option class="{{ Request::is('client/view-DFTC-rooms') || Request::is('client/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/client/view-DFTC-rooms') }}" {{ Request::is('client/view-DFTC-rooms') || Request::is('client/view-DFTC-halls') ? 'selected' : '' }}>DFTC</option>
                    </select>
                </div>
            </div>
        </div>
        <div class="row justify-content-center text-center">
            <div class="col-md-12 mt-2">
                <div class="col-md-12">
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('client/view-DFTC-rooms') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-DFTC-rooms') }}">Rooms</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('client/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-DFTC-halls') }}">Halls</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="container d-flex justify-content-center" style="padding: 0;">
                        <div class="row" style="width: 100%">
                            ...
                            <div class="col-md-7" data-aos="fade-up" data-aos-duration="800">
                                ...
                                Status:
                                @if ($bookingCount > 0 && !in_array($room->room_status, ['Occupied', 'Under-Renovation', 'Unavailable']))
                                ...
                                <div class="row d-flex align-items-end text-right">
                                    <div class="col-md-12">
                                        <p class="Montserrat text-light-green text-sm font-medium">Rate: {{ $room->room_rate }}</p>
                                            ...
                                            @if($room->room_status != 'Unavailable' && $room->room_status != 'Under-Renovation' && $room->room_status != 'Occupied')
                                                <div class="d-flex justify-content-end">
                                                    <button type="button" id="dftc-booking"
                                                        onclick="bookDftcHall('{{ addslashes(json_encode($room)) }}', '{{ addslashes(json_encode(session('loggedInSuperAdmin'))) }}')"
