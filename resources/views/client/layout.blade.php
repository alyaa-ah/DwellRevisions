...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ url('css/client-styles.css') }}">
        <link rel="stylesheet" href="{{ url('css/styles/client/styles.css') }}">
        <title>Dwell</title>
        <style>
            body {
                ...
                <div class="container-fluid mx-auto px-2">
                    <div class="flex items-center justify-between py-2 relative">
                        ...
                        <div class="hidden lg:flex lg:items-center lg:w-auto lg:space-x-6" id="top-navbar">
                            <ul class="flex flex-col lg:flex-row space-x-0 lg:space-x-2 list-none lg:ml-auto" id="navLinks">
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('client/view-home') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-home') }}">HOME</a>
                                </li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('client/view-guesthouse-rooms') || Request::is('client/view-staffhouse-rooms') || Request::is('client/view-DFTC-rooms') || Request::is('client/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-guesthouse-rooms') }}">ROOMS</a>
                                </li>
                                <li class="lg:hidden"><hr class="dropdown-divider"></li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('client/view-guesthouse-pre-reservation-form') || Request::is('client/view-staffhouse-pre-reservation-form') || Request::is('client/view-DFTC-room-pre-reservation-form') || Request::is('client/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-guesthouse-pre-reservation-form') }}">PRE-BOOK NOW</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="hidden lg:flex lg:items-center text-end">
                            <a class="navbar-brand text-light-green Montserrat icon lg:text-lg font-medium hover:text-dark-green transition ease-in-out duration-500" href="{{ url('/client/view-dashboard') }}">Hi, {{ session('loggedInCustomer')['fullname'] }}!<i class="fas fa-user fa-xl icon" style="color: #1abc02;"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="lg:hidden fixed top-0 right-0 bg-gradient-to-r from-light-white via-lightest-green to-lightest-green p-4 shadow-lg drop-shadow-lg rounded-bl-lg" id="mobileMenu" style="display: none;">
                        ...
                        <div class="flex flex-col flex-wrap px-2 mt-10">
                            <a class="navbar-brand text-light-green Montserrat icon text-lg font-medium hover:text-dark-green transition ease-in-out duration-500 mb-4 inline-block max-w-xs break-normal align-middle" href="{{ url('/client/view-dashboard') }}">
                                Hi, {{ session('loggedInCustomer')['fullname'] }}!
                            </a>
                            <ul class="flex flex-col justify-center text-center space-y-2 list-none w-full">
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('client/view-home') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-home') }}" style="width:100%">HOME</a>
                                </li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('client/view-guesthouse-rooms') || Request::is('client/view-staffhouse-rooms') || Request::is('client/view-DFTC-rooms') || Request::is('client/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-guesthouse-rooms') }}" style="width:100%">ROOMS</a>
                                </li>
                                <li><hr class="dropdown-divider bg-dark-green" style="height: 1px;"></li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('client/view-guesthouse-pre-reservation-form') || Request::is('client/view-staffhouse-pre-reservation-form') || Request::is('client/view-DFTC-room-pre-reservation-form') || Request::is('client/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/client/view-guesthouse-pre-reservation-form') }}" style="width:100%">PRE-BOOK NOW</a>
                                </li>
                                <li class="nav-item">
...
<script src="{{ url('js/client/logout.js') }}"></script>
<script src="{{ url('js/client/booking-guesthouse/functions.js') }}"></script>
<script src="{{ url('js/client/booking-staffhouse/functions.js') }}"></script>
<script src="{{ url('js/client/booking-dftc/functions.js') }}"></script>
<script src="{{ url('js/client/booking-dftchall/functions.js') }}"></script>
<script src="{{ url('js/client/pre-bookings/functions.js') }}"></script>
<script src="{{ url('js/client/edit-guesthouse/functions.js') }}"></script>
<script src="{{ url('js/client/edit-staffhouse/functions.js') }}"></script>
<script src="{{ url('js/client/edit-dftcroom/functions.js') }}"></script>
<script src="{{ url('js/client/edit-dftchall/functions.js') }}"></script>
<script src="{{ url('js/client/account/functions.js') }}"></script>
<script src="{{ url('js/client/pdf-form/functions.js') }}"></script>
<script src="{{ url('js/client/data-tables/functions.js') }}"></script>
<script src="{{ url('js/client/ratings/functions.js') }}"></script>
