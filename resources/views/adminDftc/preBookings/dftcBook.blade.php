                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="row mb-2">
                                    <div class="form-group text-light-green">
                                        ...
                                        <input type="text" class="form-control" style="background-color:#d3d3d3;" placeholder="This is read only" name="numberOfDays" id="numberOfDaysDftc" readonly>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="form-group text-light-green">
                                        <label for="numberOfNightsDftc" class="Montserrat text-sm font-semibold">Number Of Nights</label>
                                        <input type="text" class="form-control" style="background-color:#d3d3d3;" placeholder="This is read only" name="numberOfNights" id="numberOfNightsDftc" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="rate" id="rateDftc" style="background-color:#d3d3d3;" placeholder="This is read only" value="{{ isset($data['room_rate']) ? $data['room_rate'] : '' }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    <label for="capacity" class="Montserrat text-sm font-semibold">Room Bed Capacity</label>
                                    <input type="text" class="form-control" name="capacity" id="capacityDftc" style="background-color:#d3d3d3;" placeholder="This is read only" value="{{ isset($data['room_capacity']) ? $data['room_capacity'] : '' }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group text-light-green">
                                    <label for="totalAmount"  class="Montserrat text-sm font-semibold">Total Amount</label><br>
                                    <input type="text" class="form-control" name="totalAmount" id="totalAmountDftc" style="background-color:#d3d3d3;" placeholder="This is read only" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
