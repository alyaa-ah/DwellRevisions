...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/css/styles/adminDFTC/styles.css') }}">
    <title>Dwell</title>
    <style>
        body {
...
<script src="{{ url('public/js/adminDFTC/logout.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/pre-booking/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/booking-guesthouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/booking-staffhouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/booking-dftc-room/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/booking-dftc-hall/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/room/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/DFTC/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/my-guesthouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/my-staffhouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/my-dftc-room/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/my-dftc-hall/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/pdf-form/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/account/functions.js') }}"></script>
<script src="{{ url('public/js/adminDFTC/data-tables/functions.js') }}"></script>
