        ...
        <div  class="col-auto px-sm-2 px-0 min-h-min" @if($countBookings <= 0) style="height: 100vh; background-color: #1ABC02;" @else style="height: auto; background-color: #1ABC02;" @endif>
            ...
            <div class="col-9 col-md-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
                ...
                <div class="container card w-12/12 bg-light-white mt-2">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-responsive table-striped table-hover w-auto" id="guestHouseBookingTableAdminDftc">
                                <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="viewGuestHouseBookingAdminDftc('{{ addslashes(json_encode($booking) )}}')" class="btn btn-info"><i class="fa-solid fa-eye" style="color: BLACK;"></i></button>
                                                    @if ($booking->status == 'Pending Review')
                                                    <button type="button" onclick="editGuestHouseBookingAdminDftc('{{ addslashes(json_encode($booking) )}}')" class="btn btn-warning"><i class="fa-solid fa-edit" style="color: black;"></i></button>
                                                    @else
                                                        <button type="button" onclick="generateAdminDftcPdfGuestHouseBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-success"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></button>
                                                    @endif
                                                <button type="button" onclick="cancelGuestHouseBookingAdminDftc('{{ addslashes(json_encode($booking)) }}')" class="btn btn-danger"><i class="fa-solid fa-xmark" style="color: #000000;"></i></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                ...
                                                <select name="position" id="editPositionGuestHouse" class="form-control readonly-select"  style="background-color:#d3d3d3;" readonly required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                ...
                                                <input type="text" class="form-control" name="rate" id="editRateGuestHouse" style="background-color:#d3d3d3;" placeholder="0.0" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                ...
                                                <input type="text" class="form-control" name="totalAmount" id="editTotalAmountGuestHouse" style="background-color:#d3d3d3;" placeholder="0.0" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
