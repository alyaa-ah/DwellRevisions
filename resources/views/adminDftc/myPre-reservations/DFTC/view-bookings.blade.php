...
@section('content')<div class="container-fluid m-0 w-full justify-content-center align-items-center" @if($countBookings <= 0) style="height: 100vh;" @else style="height: auto;" @endif >
    <div class="row">
        <!-- Sidebar -->
        <div  class="col-auto px-sm-2 px-0 min-h-min" @if($countBookings <= 0) style="height: 100vh; background-color: #1ABC02;" @else style="height: auto; background-color: #1ABC02;" @endif>
            ...
            <div class="col-9 col-md-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
                ...
                <div class="container card w-12/12 bg-light-white mt-2">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-responsive table-striped table-hover w-auto" id="dftcBookingTableAdminDftc">
                                <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                    @if ($booking->room_type == "Hall")
                                                        ...
                                                        @if ($booking->room_type == "Pending Review")
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                    ...
                                                    <input type="text" class="form-control" name="capacity" id="editCapacityDftcRoom" placeholder="0" style="background-color:#d3d3d3;"  readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group Montserrat text-sm font-semibold text-light-green">
