                                ...
                                <div class="col-md-12">
                                    ...
                                    @if(session()->has('loggedInCustomer') || session()->has('loggedInSuperAdmin') || session()->has('loggedInAdminDftc'))
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button onclick="viewStaffHousePreBookingsAdminDftc('{{ $room->id }}')" class="mt-[1 rem] btn lg:rounded-full md:rounded bg-light-green text-white Montserrat hover:bg-dark-green transition ease-in-out duration-500 mr-2 flex items-center space-x-1">
                                            ...
                                            <button type="button" id="staffHouse-booking"
                                                onclick="bookStaffHouse('{{ addslashes(json_encode($room)) }}', '{{ addslashes(json_encode(session('loggedInAdminDftc'))) }}')"
