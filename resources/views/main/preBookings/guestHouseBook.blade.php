    ...
    <div class="card w-9/12 bg-light-white" data-aos="fade-up" data-aos-duration="800">
        <div class="card-body">
            <form id="guestHouse-booking-form">
                @csrf
                <table class="table table-borderless mx-auto"></table>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    ...
                                    <select name="room_number" id="room_number" class="form-control" readonly>
                            ...
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="numberOfDays" id="numberOfDays" readonly>
                                </div>
                            </td>
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    <label for="numberofNights">Number Of Nights</label>
                                    <input type="text" class="form-control" name="numberOfNights" id="numberOfNights" readonly>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="number" class="form-control" name="numOfMale" id="numOfMale">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="number" class="form-control" name="numOfFemale" id="numOfFemale">
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="rate" id="rate" value="{{ isset($data['room_rate']) ? $data['room_rate'] : '' }}" readonly>
                                </div>
                            </td>
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    <label for="capacity">Room Bed Capacity</label>
                                    <input type="text" class="form-control" name="capacity" id="capacity" value="{{ isset($data['room_capacity']) ? $data['room_capacity'] : '' }}" readonly>
                                </div>
                            </td>
                            <td class="Montserrat font-semibold">
                                <div class="form-group text-light-green">
                        ...
                        <tr>
                            <td class="Montserrat  text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    ...
                                    <textarea name="maleGuests" id="maleGuests" cols="5" rows="5" class="form-control"></textarea>
                                </div>
                            </td>
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    <label for="femaleGuests">Name of Guest/s (Female)</label>
                                    <textarea name="femaleGuests" id="femaleGuests" cols="5" rows="5" class="form-control"></textarea>
                                </div>
                            </td>
                            <td class="Montserrat font-semibold">
                                <div class="form-group text-light-green">
                                    <label for="specialRequests">Special Requests</label>
                                    <textarea class="form-control"  name="specialRequests" id="specialRequests" cols="5" rows="5"></textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header bg-light-green text-center">
            <h1 class="modal-title Montserrat text-white font-semibold fs-5">REQUEST FOR ACCOMMODATION AT THE GUEST HOUSE</h1>
