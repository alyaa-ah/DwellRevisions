                        ...
                        <tr>
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    ...
                                    <input type="text" class="form-control" name="rate" id="rateDftc" value="{{ isset($data['room_rate']) ? $data['room_rate'] : '' }}" readonly>
                                </div>
                            </td>
                            <td class="Montserrat text-sm font-semibold">
                                <div class="form-group text-light-green">
                                    <label for="capacity">Room Bed Capacity</label>
                                    <input type="text" class="form-control" name="capacity" id="capacityDftc" value="{{ isset($data['room_capacity']) ? $data['room_capacity'] : '' }}" readonly>
                                </div>
                            </td>
                            <td class="Montserrat font-semibold">
                                <div class="form-group text-light-green">
                                    <label for="totalAmount" class="text-sm">Total Amount</label><br>
                                    <input type="text" class="form-control" name="totalAmount" id="totalAmountDftc" readonly>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="Montserrat font-semibold">
                                <div class="form-group text-light-green">
                                    ...
                                    <textarea class="form-control"  name="specialRequests" id="specialRequestsDftc" cols="5" rows="5"></textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
