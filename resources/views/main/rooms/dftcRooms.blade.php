                            ...
                            <div class="col-md-7" data-aos="fade-up" data-aos-duration="800">
                                <div class="container" style="padding: 0;">
                                    <div class="row d-flex align-items-center">
                                        <div class="col-md-6">
                                        <p class="Montserrat h-12 text-2xl sm:text-4xl md:text-5xl lg:text-5xl font-extrabold textGradient text-left">{{ $room->room_number }}</p>
                                    </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td class="Montserrat text-light-green text-sm font-semibold text-justify">Inlcusion: {{ $room->room_inclusion }}</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="row d-flex align-items-end text-right">
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button onclick="viewDftcRoomPreBookingsMain('{{ $room->id }}')" class="btn lg:rounded-full md:rounded mt-1 bg-light-green text-white Montserrat hover:bg-dark-green transition ease-in-out duration-500 mr-2 flex items-center space-x-1">
