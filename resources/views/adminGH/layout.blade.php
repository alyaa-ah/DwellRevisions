...
<script src="{{ url('js/adminGH/logout.js') }}"></script>
<script src="{{ url('js/adminGH/pre-booking/functions.js') }}"></script>
<script src="{{ url('js/adminGH/booking-guesthouse/functions.js') }}"></script>
<script src="{{ url('js/adminGH/booking-staffhouse/functions.js'); }}"></script>
<script src="{{ url('js/adminGH/booking-dftc-room/functions.js'); }}"></script>
<script src="{{ url('js/adminGH/booking-dftc-hall/functions.js'); }}"></script>
<script src="{{ url('js/adminGH/room/functions.js') }}"></script>
<script src="{{ url('js/adminGH/guesthouse/functions.js') }}"></script>
<script src="{{ url('js/adminGH/my-guesthouse/functions.js') }}"></script>
<script src="{{ url('js/adminGH/my-staffhouse/functions.js') }}"></script>
<script src="{{ url('js/adminGH/my-dftc-room/functions.js') }}"></script>
<script src="{{ url('js/adminGH/my-dftc-hall/functions.js') }}"></script>
<script src="{{ url('js/adminGH/pdf-form/functions.js') }}"></script>
<script src="{{ url('js/adminGH/account/functions.js') }}"></script>
<script src="{{ url('js/adminGH/data-tables/functions.js') }}"></script>
