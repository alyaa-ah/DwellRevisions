...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/css/styles/adminGH/styles.css') }}">
    <title>Dwell</title>
    <style>
        body {
            ...
            <div class="container-fluid mx-auto px-2">
                <div class="flex items-center justify-between py-2 relative">
                    <div class="flex items-center w-full lg:w-auto">
                        <a class="navbar-brand" href="{{url('adminGH/')}}">
                    ...
                    <div class="hidden lg:flex lg:items-center lg:w-auto lg:space-x-6" id="top-navbar">
                        <ul class="flex flex-col lg:flex-row space-x-0 lg:space-x-2 list-none lg:ml-auto" id="navLinks">
                            <li class="nav-item">
                                <a class="btn btn-nav Montserrat {{ Request::is('adminGH/view-home') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-home') }}">HOME</a>
                            </li>
                            <li class="nav-item">
                                <a class="btn btn-nav Montserrat {{ Request::is('adminGH/view-guesthouse-rooms') || Request::is('adminGH/view-staffhouse-rooms') || Request::is('adminGH/view-DFTC-rooms') || Request::is('adminGH/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-guesthouse-rooms') }}">ROOMS</a>
                            </li>
                            <li class="lg:hidden"><hr class="dropdown-divider"></li>
                            <li class="nav-item">
                                <a class="btn btn-nav Montserrat {{ Request::is('adminGH/view-guesthouse-pre-reservation-form') || Request::is('adminGH/view-staffhouse-pre-reservation-form') || Request::is('adminGH/view-DFTC-room-pre-reservation-form') || Request::is('adminGH/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-guesthouse-pre-reservation-form') }}">PRE-BOOK NOW</a>
                            </li>
                            <li class="nav-item">
                                <a id="signOutButtonSmallerDevice" class="btn btn-nav Montserrat inactive">LOGOUT</a>
                            </li>
                        </ul>
                    </div>
                    <!-- User greetings on the right (outside toggle button)-->
                    <div class="hidden lg:flex lg:items-center text-end">
                        <a class="navbar-brand text-light-green Montserrat icon lg:text-lg font-medium hover:text-dark-green transition ease-in-out duration-500" href="{{ url('/adminGH/view-dashboard') }}">Hi, {{ session('loggedInAdminGH')['fullname'] }}!<i class="fas fa-user fa-xl icon" style="color: #1abc02;"></i></a>
                    </div>
                </div>
                ...
                <div class="lg:hidden fixed top-0 right-0 bg-gradient-to-r from-light-white via-lightest-green to-lightest-green p-4 shadow-lg drop-shadow-lg rounded-bl-lg" id="mobileMenu" style="display: none;">
                    ...
                    <div class="flex flex-col flex-wrap px-2 mt-10">
                        <a class="navbar-brand text-light-green Montserrat icon text-lg font-medium hover:text-dark-green transition ease-in-out duration-500 mb-4 inline-block max-w-xs break-normal align-middle" href="{{ url('/adminGH/view-dashboard') }}">
                            Hi, {{ session('loggedInAdminGH')['fullname'] }}! </a>
                        <ul class="flex flex-col justify-center text-center space-y-2 list-none w-full">
                            <li class="nav-item">
                                <a class="btn btn-nav Montserrat {{ Request::is('adminGH/view-home') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-home') }}" style="width:100%;">HOME</a>
                            </li>
                            <li class="nav-item">
                                <a class="btn btn-nav Montserrat w-full {{ Request::is('adminGH/view-guesthouse-rooms') || Request::is('adminGH/view-staffhouse-rooms') || Request::is('adminGH/view-DFTC-rooms') || Request::is('adminGH/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-guesthouse-rooms') }}" style="width:100%;">ROOMS</a>
                            </li>
                            <li><hr class="dropdown-divider bg-dark-green" style="height: 1px;"></li>
                            <li class="nav-item">
                                <a class="btn btn-nav Montserrat {{ Request::is('adminGH/view-guesthouse-pre-reservation-form') || Request::is('adminGH/view-staffhouse-pre-reservation-form') || Request::is('adminGH/view-DFTC-room-pre-reservation-form') || Request::is('adminGH/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-guesthouse-pre-reservation-form') }}" style="width:100%;">PRE-BOOK NOW</a>
                            </li>
                            <li class="nav-item">
...
<script src="{{ url('public/js/adminGH/logout.js') }}"></script>
<script src="{{ url('public/js/adminGH/pre-booking/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/booking-guesthouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/booking-staffhouse/functions.js'); }}"></script>
<script src="{{ url('public/js/adminGH/booking-dftc-room/functions.js'); }}"></script>
<script src="{{ url('public/js/adminGH/booking-dftc-hall/functions.js'); }}"></script>
<script src="{{ url('public/js/adminGH/room/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/guesthouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/my-guesthouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/my-staffhouse/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/my-dftc-room/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/my-dftc-hall/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/pdf-form/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/account/functions.js') }}"></script>
<script src="{{ url('public/js/adminGH/data-tables/functions.js') }}"></script>
