...
<div class="container-fluid m-0 w-full justify-content-center align-items-center" style="height: auto;">
    <div class="row">
        <!-- Sidebar -->
        <div  class="col-auto px-sm-2 px-0 min-h-min" style="background-color: #1ABC02; height: auto;">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2 mb-2">
                            <div class="row d-flex justify-content-center">
                                    <table class="table table-responsive table-hover table-striped w-auto" id="accountTableAdminGH">
                                        <thead>
                                        <tr>
                                        ...
                                        @foreach ($clients as $client)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button onclick="viewAccountAdminGH('{{ addslashes(json_encode($client)) }}')" type="button" class="btn btn-info" title="View Button"><i class="fa-solid fa-eye" style="color: BLACK;"></i></button>
                                                    <button onclick="editAccountAdminGH('{{ addslashes(json_encode($client)) }}')" type="button" class="btn btn-warning" title="Edit Button"><i class="fa-solid fa-edit" style="color: #000000;"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
