            ...
            <div class="col-md-12 mt-4">
                ...
                <div class="select-group d-md-none">
                    <select class="form-select h-9 Montserrat bg-light-green text-dark-white w-100" style="width:100%;" onchange="location = this.value;">
                        ...
                        <option class="{{ Request::is('adminGH/view-DFTC-rooms') || Request::is('adminGH/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-DFTC-rooms') }}" {{ Request::is('adminGH/view-DFTC-rooms')  || Request::is('adminGH/view-DFTC-halls')? 'selected' : '' }}>DFTC</option>
                    </select>
                </div>
            </div>
        </div>
                                    ...
                                    @if(session()->has('loggedInCustomer') || session()->has('loggedInSuperAdmin') || session()->has('loggedInAdminGH'))
                                        @if($room->room_status != 'Unavailable' && $room->room_status != 'On-Renovation')
                                            <div class="d-flex justify-content-end">
                                                <button onclick="viewDftcRoomPreBookingsAdminGH('{{ $room->id }}')" class="mt-[1 rem] btn lg:rounded-full md:rounded bg-light-green text-white Montserrat hover:bg-dark-green transition ease-in-out duration-500 mr-2 flex items-center space-x-1">
                                                ...
                                                <button type="button" id="dftc-booking"
                                                    onclick="bookDftc('{{ addslashes(json_encode($room)) }}', '{{ addslashes(json_encode(session('loggedInAdminGH'))) }}')"
