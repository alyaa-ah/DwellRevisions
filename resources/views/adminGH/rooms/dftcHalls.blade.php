    ...
    <div class="container flex-column d-flex justify-content-center align-items-center">
        <div class="row align-items-center m-1" data-aos="fade-up" data-aos-duration="800">
            <div class="col-md-12 text-center">
                ...
                <div class="button-group d-none d-md-flex mt-3">
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminGH/view-guesthouse-rooms') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right: 5px;" href="{{ url('/adminGH/view-guesthouse-rooms') }}">Guest House</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminGH/view-staffhouse-rooms') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right: 5px;" href="{{ url('/adminGH/view-staffhouse-rooms') }}">Staff House</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminGH/view-DFTC-rooms') || Request::is('adminGH/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right: 5px;" href="{{ url('/adminGH/view-DFTC-rooms') }}">DFTC</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 mt-4">
                ...
                <div class="select-group d-md-none">
                    <select class="form-select h-9 Montserrat bg-light-green text-dark-white w-100" style="width:100%;" onchange="location = this.value;">
                        <option class="{{ Request::is('adminGH/view-guesthouse-rooms') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-guesthouse-rooms') }}" {{ Request::is('adminGH/view-guesthouse-rooms') ? 'selected' : '' }}>Guest House</option>
                        <option class="{{ Request::is('adminGH/view-staffhouse-rooms') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-staffhouse-rooms') }}" {{ Request::is('adminGH/view-staffhouse-rooms') ? 'selected' : '' }}>Staff House</option>
                        <option class="{{ Request::is('adminGH/view-DFTC-rooms') || Request::is('adminGH/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-DFTC-rooms') }}" {{ Request::is('aadminGH/view-DFTC-rooms')  || Request::is('adminGH/view-DFTC-halls')? 'selected' : '' }}>DFTC</option>
                    </select>
                </div>
            </div>
        </div>
        <div class="row justify-content-center" data-aos="fade-up" data-aos-duration="800">
            <div class="col-md-12 mt-2">
                <div class="col-md-12">
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminGH/view-DFTC-rooms') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-DFTC-rooms') }}">Rooms</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminGH/view-DFTC-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-DFTC-halls') }}">Halls</a>
                </div>
            </div>  
        </div>
...
@foreach($dftcHalls as $index => $room)
                        ...
                        <div class="col-md-7" data-aos="fade-up" data-aos-duration="800">
                            <div class="container" style="padding: 0;">
                                <div class="row d-flex align-items-center">
                                    <div class="col-md-12">
                                        <p class="Montserrat h-12 text-1xl sm:text-1xl md:text-1xl lg:text-4xl font-extrabold textGradient text-lef">{{ $room->room_number }}</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @if(session()->has('loggedInCustomer') || session()->has('loggedInSuperAdmin') || session()->has('loggedInAdminGH'))
                                        @if($room->room_status != 'Unavailable' && $room->room_status != 'On-Renovation')
                                            <div class="d-flex justify-content-end">
                                                <button onclick="viewDftcHallPreBookingsAdminGH('{{ $room->id }}')" class="mt-[1 rem] btn lg:rounded-full md:rounded bg-light-green text-white Montserrat hover:bg-dark-green transition ease-in-out duration-500 mr-2 flex items-center space-x-1">
