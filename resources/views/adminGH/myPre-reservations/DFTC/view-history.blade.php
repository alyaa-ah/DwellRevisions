        ...
        <div class="col-9 col-md-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 d-flex justify-content-center mt-2">
                    ...
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminGH/view-my-guesthouse-history*') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-my-guesthouse-history') }}">Guest House</a>
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminGH/view-my-staffhouse-history*') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-my-staffhouse-history') }}">Staff House</a>
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminGH/view-my-DFTC-history*') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-my-DFTC-history') }}">DFTC</a>
                </div>
                 </div>  
            </div>
            <div class="row justify-content-center">
                <div class="col-md-12 mt-2">
                    ...
                    <div class="select-group d-md-none">
                        <select class="form-select h-9 Montserrat bg-light-green text-dark-white sm:my-2 sm:w-full md:w-auto" onchange="location = this.value;">
                            <option class="{{ Request::is('adminGH/view-my-guesthouse-history*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-my-guesthouse-history') }}" {{ Request::is('adminGH/view-my-guesthouse-history*') ? 'selected' : '' }}>Guest House</option>
                            <option class="{{ Request::is('adminGH/view-my-staffhouse-history*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-my-staffhouse-history') }}" {{ Request::is('adminGH/view-my-staffhouse-history*') ? 'selected' : '' }}>Staff House</option>
                            <option class="{{ Request::is('adminGH/view-my-DFTC-history*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-my-DFTC-history') }}" {{ Request::is('adminGH/view-my-DFTC-history*') ? 'selected' : '' }}>DFTC</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="container card w-100 bg-light-white mt-3">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-responsive table-striped table-hover w-auto" id="dftcHistoryTableAdminGH">
                            <thead>
