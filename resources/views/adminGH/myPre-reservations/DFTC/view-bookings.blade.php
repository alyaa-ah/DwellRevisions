            ...
            <div class="row justify-content-center">
                <div class="col-md-12 d-flex justify-content-center mt-2">
                    ...
                    <div class="button-group d-none d-md-flex">
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminGH/view-my-ongoing-guesthouse-pre-reservations*') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-my-ongoing-guesthouse-pre-reservations') }}">Guest House</a>
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminGH/view-my-ongoing-staffhouse-pre-reservations*') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-my-ongoing-staffhouse-pre-reservations') }}">Staff House</a>
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('adminGH/view-my-ongoing-DFTC-pre-reservations*') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-my-ongoing-DFTC-pre-reservations') }}">DFTC</a>
                    </div>
                 </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="select-group d-md-none">
                    <select class="form-select h-9 Montserrat bg-light-green text-dark-white sm:my-2 sm:w-full md:w-auto" onchange="location = this.value;">
                        <option class="{{ Request::is('adminGH/view-my-ongoing-guesthouse-pre-reservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-my-ongoing-guesthouse-pre-reservations') }}" {{ Request::is('adminGH/view-my-ongoing-guesthouse-pre-reservations*') ? 'selected' : '' }}>Guest House</option>
                        <option class="{{ Request::is('adminGH/view-my-ongoing-staffhouse-pre-reservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-my-ongoing-staffhouse-pre-reservations') }}" {{ Request::is('adminGH/view-my-ongoing-staffhouse-pre-reservations*') ? 'selected' : '' }}>Staff House</option>
                        <option class="{{ Request::is('adminGH/view-my-ongoing-DFTC-pre-reservations*') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/adminGH/view-my-ongoing-DFTC-pre-reservations') }}" {{ Request::is('adminGH/view-my-ongoing-DFTC-pre-reservations*') ? 'selected' : '' }}>DFTC</option>
                    </select>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                                @if ($booking->room_type == "Hall")
                                                    <button type="button" onclick="viewAdminGHDftcHallBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-info"><i class="fa-solid fa-eye" style="color: BLACK;" title="View Button for hall"></i></button>
                                                        @if ($booking->status == "Pending Review")
                                                            <button type="button" onclick="editAdminGHDftcHallBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-warning"><i class="fa-solid fa-edit" style="color: black;" title="Edit Button for hall"></i></button>
                                                        @endif
                                                @else
                                                        <button type="button" onclick="viewAdminGHDftcRoomBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-info"><i class="fa-solid fa-eye" style="color: BLACK;" title="View Button for room"></i></button>
                                                    @if ($booking->status == "Pending Review")
                                                        <button type="button" onclick="editAdminGHDftcRoomBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-warning"><i class="fa-solid fa-edit" style="color: black;" title="Edit Button for room"></i></button>
                                                    @endif
                                                @endif
                                                @if ($booking->status == 'Pending Review')
                                                @else
                                                <button type="button" onclick="generateAdminGHPdfDftcBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-success"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></button>
                                                @endif
                                            <button type="button" onclick="cancelAdminGHDftcBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-danger"><i class="fa-solid fa-xmark" style="color: #000000;"></i></i></button>
                                        </td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group Montserrat font-semibold text-light-green">
                                                    ...
                                                    <select name="position" id="editPositionDftcRoom" class="form-control readonly-select" style="background-color:#d3d3d3;" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                    ...
                                                    <input type="text" class="form-control" name="totalAmount" id="editTotalAmountDftcRoom" placeholder="0.00" style="background-color:#d3d3d3;"  readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="border-2 rounded-md border-green-500 p-1 m-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat font-semibold text-light-green">
                                                <label class="text-sm">Position/Designation<span class="text-red-600">*</span></label><br>
                                                <select name="position" id="editPositionDftcHall" class="form-control" style="background-color:#d3d3d3;" required>
                                                    <option value="">Select Position/Designation</option>
                                                    <option value="Guest">Guest</option>
                                                    <option value="Student">Student</option>
                                                    <option value="Employee">Employee</option>
                                             ...
                                             <div class="row">
                                                <div class="col-md-6 md-2">
                                                    <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                        ...
                                                        <input type="number" name="janitorservices" id="editJanitorialServicesDftcHall" class="form-control" placeholder="0.00" style="background-color:#d3d3d3;" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-2">
                                                    <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                        <label for="avservices">AV Services</label>
                                                        <input type="number" name="avservices" id="editAvServicesDftcHall" class="form-control" placeholder="0.00" style="background-color:#d3d3d3;" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="form-group Montserrat text-sm font-semibold  text- text-light-green mt-4">
                                                        ...
                                                        <input type="number" name="extracharge" id="extrachargeEditDftcHall" class="form-control" placeholder="0.00" style="background-color:#d3d3d3;" readonly>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <div class="form-group Montserrat text-sm font-semibold text-light-green mt-4">
                                                        ...
                                                        <input type="number" name="timerate" id="editTimeRateDftcHall" class="form-control" placeholder="0.00" style="background-color:#d3d3d3;" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light-green">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="form-group" id="checkboxContainerEditDftcHall" style="display: none;">
                                <div class="d-flex align-items-start">
                                    <input class="form-check-input mr-1" type="checkbox" value="" id="flexCheckDefaultEditDftcHall">
                                    <label class="form-check-label text-white Montserrat text-sm font-semibold" for="flexCheckDefaultEditDftcHall" style="margin-left: 0;">
                                        I hereby agree to conform to and abide by the terms and conditions, rules, and regulations.
                                    </label>
                                </div>
                            </div>
