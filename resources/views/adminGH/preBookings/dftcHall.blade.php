    ...
    <div class="container flex-column d-flex justify-content-center align-items-center">
        ...
        <div class="row justify-content-center" data-aos="fade-up" data-aos-duration="800">
            <div class="col-md-12 mt-2">
                <div class="col-md-12">
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminGH/view-DFTC-room-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-DFTC-room-pre-reservation-form') }}">Room</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('adminGH/view-DFTC-hall-pre-reservation-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/adminGH/view-DFTC-hall-pre-reservation-form') }}">Hall</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="col">
                        <div class="form-group mr-1" id="checkboxContainerPreBookDftcHall" style="display:none;">
                            <div class="d-flex align-items-start">
                                ...
                                <label class="form-check-label text-white Montserrat text-sm font-semibold" for="flexCheckDefaultDFTCHall" style="margin-left: 0;">
