...
<div class="container-fluid m-0 w-full justify-content-center align-items-center" @if($countBookings <= 0) style="height: 100vh;" @else style="height: auto;" @endif >
    <div class="row">
        ...
        <div class="col-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <p class="Montserrat h-12  lg:text-5xl text-3xl font-extrabold textGradient text-center" style="margin-top: 1rem">GUEST HOUSE</p>
            <div class="d-flex mt-2 justify-content-center align-items-center">
                <div class="card w-100 xl:w-full bg-light-white mt-2 px-2">
                    <div class="row">
                        <div class="col-md-12 mt-2 mb-1">
                            <table class="table table-responsive table-striped table-hover w-auto"id="guestHouseBookingTable">
                                <thead>
                                    <tr>
                                    ...
                                    @foreach ($bookings as $booking)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button id="client-generatepdf-form" type="button" onclick="generateClientPdfGuestHouse('{{ addslashes(json_encode($booking)) }}')" class="btn btn-success"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></button>
                                                <button type="button" onclick="cancelGuestHouseBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-danger"><i class="fa-solid fa-xmark" style="color: #000000;"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ url('generateGuestHousePdfReport') }}" target="_blank" class="btn btn-lg btn-info ml-4"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></a>
                        </div>
                    </div>
                </div>
            </div>
