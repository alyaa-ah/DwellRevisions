                    ...
                    <div class="card w-100 xl:w-full bg-light-white mt-2 px-2">
                        <div class="row">
                            <div class="col-md-12 mt-2 mb-2">
                                <table class="table table-responsive table-striped table-hover w-auto" id="guestHouseHistoryTable">
                                    <thead>
                            ...
                            <div class="col-md-3 mb-3">
                                <a href="{{ url('generateGuestHouseHistoryPdfReport') }}" target="_blank" class="btn btn-lg btn-info ml-4"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></a>
                            </div>
                        </div>
                    </div>   
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 border-4 rounded-md border-green-600">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-1">
                                    <p id="bookingNumberGuestHouse-modal"></p>
                                </div>
                            </div>
                            <div class="row bg-gray-100">
                                <div class="col-md-2 mb-1">
