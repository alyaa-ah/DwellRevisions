        ...
        <div class="col-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 d-flex justify-content-center mt-2">
                    ...
                    <div class="button-group d-none d-md-flex ">
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('superAdmin/view-guesthouse-preservations') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" href="{{ url('/superAdmin/view-guesthouse-preservations') }}">Guest House</a>
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('superAdmin/view-staffhouse-preservations') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" href="{{ url('/superAdmin/view-staffhouse-preservations') }}">Staff House</a>
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('superAdmin/view-DFTC-preservations') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" href="{{ url('/superAdmin/view-DFTC-preservations') }}">DFTC</a>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <!-- Buttons for small screens -->
                    <div class="select-group d-md-none">
                        <select class="form-select h-9 Montserrat bg-light-green text-dark-white sm:my-2 sm:w-full md:w-auto" onchange="location = this.value;">
                            <option class="{{ Request::is('superAdmin/view-guesthouse-preservations') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/superAdmin/view-guesthouse-preservations') }}" {{ Request::is('superAdmin/view-guesthouse-preservations') ? 'selected' : '' }}>Guest House</option>
                            <option class="{{ Request::is('superAdmin/view-staffhouse-preservations') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/superAdmin/view-staffhouse-preservations') }}" {{ Request::is('superAdmin/view-staffhouse-preservations') ? 'selected' : '' }}>Staff House</option>
                            <option class="{{ Request::is('superAdmin/view-DFTC-preservations') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/superAdmin/view-DFTC-preservations') }}" {{ Request::is('superAdmin/view-DFTC-preservations') ? 'selected' : '' }}>DFTC</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex mt-2 justify-content-center align-items-center">
                <div class="card w-100 xl:w-full bg-light-white mt-2 px-2">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-responsive table-striped table-hover w-auto" id="dftcRoom_Table">
                                <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                    @if ($booking->room_type == "Hall")
                                                        ...
                                                        <button type="button" onclick="editDftcHallBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-warning"><i class="fa-solid fa-edit" style="color: black;" title="Edit Button for hall"></i></button>
                                                    @else
                                                        <button type="button" onclick="viewDftcRoomBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-info"><i class="fa-solid fa-eye" style="color: BLACK;" title="View Button for room"></i></button>
                                                        <button type="button" onclick="editDftcRoomBooking('{{ addslashes(json_encode($booking)) }}')" class="btn btn-warning"><i class="fa-solid fa-edit" style="color: black;" title="Edit Button for room"></i></button>
                                                    @endif
                    ...
                    <div class="col-md-3 mb-3">
                        <a href="{{ url('generateDftcPdfReport') }}" target="_blank" class="btn btn-lg btn-info ml-4"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group Montserrat font-semibold text-light-green">
                                                    ...
                                                    <select name="position" id="editPositionDftcRoom" class="form-control readonly-select" style="background-color:#d3d3d3;" required readonly>
                                ...
                                <div class="border-2 rounded-md border-green-500 p-1 m-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat font-semibold text-light-green">
                                                <label class="text-sm">Position/Designation<span class="text-red-600">*</span></label><br>
                                                <select name="position" id="editPositionDftcHall" class="form-control readonly-select" style="background-color:#d3d3d3;"  readonly required>
                                                    <option value="">Select Position/Designation</option>
                                                    <option value="Guest">Guest</option>
                                                    <option value="Student">Student</option>
                                                    <option value="Employee">Employee</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                                ...
                                                <input type="text" class="form-control" name="capacity" id="editCapacityDftcHall" style="background-color:#d3d3d3;"style="background-color:#d3d3d3;"  placeholder="0.00" readonly >
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group Montserrat text-sm font-semibold text-light-green">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group Montserrat text-sm font-semibold  text- text-light-green mt-4">
                                                        ...
                                                        <input type="number" name="extracharge" id="extrachargeEditDftcHall" class="form-control" style="background-color:#d3d3d3;"  placeholder="0.00" style="background-color:#d3d3d3;" readonly>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <div class="form-group Montserrat text-sm font-semibold text-light-green mt-4">
                                                        ...
                                                        <input type="number" name="timerate" id="editTimeRateDftcHall" class="form-control" style="background-color:#d3d3d3;"  placeholder="0.00" style="background-color:#d3d3d3;" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light-green">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="form-group" id="checkboxContainerEditDftcRoom" style="display: none;">
