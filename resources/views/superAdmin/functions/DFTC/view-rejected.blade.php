        ...
        <div class="col-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 d-flex justify-content-center" style="margin-top: 1rem;">
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('superAdmin/view-DFTC-canceled-preservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('superAdmin/view-DFTC-canceled-preservations') }}">Canceled</a>
                    <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('superAdmin/view-DFTC-rejected-preservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-DFTC-rejected-preservations') }}">Rejected</a>
                </div>
            </div>
                ...
                <div class="card w-100 xl:w-full bg-light-white mt-2 px-2">
                     <div class="row">
                        <div class="col-md-12 mt-2 mb-2">
                            <table class="table table-responsive table-hover table-striped w-auto" id="rejectedDftcTable">
                                <thead>
