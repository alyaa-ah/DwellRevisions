        ...
        <div class="col-10 content m-3 mx-auto items-center" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="d-flex mt-2 justify-content-center align-items-center">
                <div class="card w-100 xl:w-full bg-light-white mt-2 px-2">
                    <div class="row">
                    <div class="col-md-12">
                        <table class="table table-responsive table-striped table-hover w-auto" id="staffHouseBookingTable">
                            <thead>
                                ...
                                @foreach ($bookings as $booking)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" onclick="generateClientPdfStaffHouse('{{ addslashes(json_encode($booking)) }}')" class="btn btn-success"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></button>
                    ...
                    <div class="col-md-3 mb-3">
                        <a href="{{ url('generateStaffHousePdfReport') }}" target="_blank" class="btn btn-lg btn-info ml-4"><i class="fa-solid fa-file-pdf" style="color: #000000;"></i></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form id="edit-staffHouse-booking-form">
                                ...
                                <div class="container mx-auto mt-2">
                                    <div class="border-2 rounded-md border-green-500 p-1 m-2">
                                        ...
                                        <div class="row mb-2 Montserrat text-sm font-semibold" id="editLetterInputCellStaffHouse" style="display: none;">
                                            <div class="col-12">
                                        ...
                                        <tr>
                                            <td class="Montserrat text-sm font-semibold">
                                                <div class="form-group text-light-green">
                                                    ...
                                                    <select name="reason" id="reasonSH" class="form-control">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light-green">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="form-group" id="checkboxContainerEditPreBookStaffHouse" style="display: none;">
...
<script src="{{ url('js/superadmin/edit-staffhouse-booking/payment.js') }}"></script>
@endsection
