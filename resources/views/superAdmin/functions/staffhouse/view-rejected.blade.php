            ...
            <p class="Montserrat h-12 text-3xl font-extrabold textGradient" style="margin-top: 3rem">VOIDS</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 d-flex justify-content-center" style="margin-top: 1rem;">
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('superAdmin/view-staffhouse-canceled-preservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-staffhouse-canceled-preservations') }}">Canceled</a>
                        <a class="btn btn-nav h-9 Montserrat mx-1 {{ Request::is('superAdmin/view-staffhouse-rejected-preservations') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-staffhouse-rejected-preservations') }}">Rejected</a>
                    </div>
                </div>
                    ...
                    <div class="card w-100 xl:w-full bg-light-white mt-2 px-2">
                        <div class="row">
                            <div class="col-md-12 mt-2 mb-2">
                                <table class="table table-responsive table-hover table-striped w-auto" id="rejectedStaffHouseTable">
                                        <thead>
