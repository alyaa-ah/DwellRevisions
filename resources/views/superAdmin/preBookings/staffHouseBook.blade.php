            ...
            <div class="col-md-12 mt-4">
                ...
                <div class="select-group d-md-none">
                    <select class="form-select h-9 Montserrat bg-light-green text-dark-white w-100" style="width:100%;" onchange="location = this.value;">
                        <option class="{{ Request::is('superAdmin/view-guesthouse-form') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/superAdmin/view-guesthouse-form') }}" {{ Request::is('superAdmin/view-guesthouse-form') ? 'selected' : '' }}>Guest House</option>
                        <option class="{{ Request::is('superAdmin/view-staffhouse-form') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/superAdmin/view-staffhouse-form') }}" {{ Request::is('superAdmin/view-staffhouse-form') ? 'selected' : '' }}>Staff House</option>
                        <option class="{{ Request::is('superAdmin/view-dftc-room-form') || Request::is('superAdmin/view-dftc-hall-form') ? 'bg-light-green text-dark-white' : 'bg-gray-300 text-gray-600' }}" value="{{ url('/superAdmin/view-dftc-room-form') }}" {{ Request::is('superAdmin/view-dftc-room-form') || Request::is('superAdmin/view-dftc-hall-form') ? 'selected' : '' }}>DFTC</option>
                    </select>
                </div>
            </div>
        </div>
...
<script src="{{ url('public/js/superadmin/staffhouse-booking/staffhouse-payment.js') }}"></script>
@endsection
