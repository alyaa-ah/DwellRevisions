        ...
        <div class="row align-items-center m-1" data-aos="fade-up" data-aos-duration="800">
            <div class="col-md-12 text-center">
                ...
                <div class="button-group d-none d-md-flex mt-3">
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('superAdmin/view-guesthouse-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right:5px;" href="{{ url('/superAdmin/view-guesthouse-form') }}">Guest House</a>
                    <a class="btn btn-nav h-9 Montserrat {{ Request::is('superAdmin/view-staffhouse-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" style="margin-right:5px;"  href="{{ url('/superAdmin/view-staffhouse-form') }}">Staff House</a>
