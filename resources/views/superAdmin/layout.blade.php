...
<head>
    ...
    <!-- External CSS -->
    <link rel="stylesheet" href="{{ asset('/public/css/styles1.css') }}">
    <link rel="stylesheet" href="{{ url('public/css/styles/superadmin/styles.css') }}">
    <title>Dwell</title>
    <style>
        body {
            background-image: url('{{ asset("/public/images/BackgroundPicture.png") }}');
        ...
        @keyframes fb-hover {
            0% {
                content: url('{{ asset("/public/images/fb.svg") }}');
            }
            100% {
                content: url('{{ asset("/public/images/fb-hover.svg") }}');
            }
        }

        @keyframes gmail-hover {
            0% {
                content: url('{{ asset("/public/images/gmail.svg") }}');
            }
            100% {
                content: url('{{ asset("/public/images/gmail-hover.svg") }}');
            }
        }

        @keyframes ig-hover {
            0% {
                content: url('{{ asset("/public/images/ig.svg") }}');
            }
            100% {
                content: url('{{ asset("/public/images/ig-hover.svg") }}');
            }
        }
    </style>
</head>
                ...
                <div class="container-fluid mx-auto px-2">
                    <div class="flex items-center justify-between py-2 relative">
                        <div class="flex items-center w-full lg:w-auto">
                            <a class="navbar-brand" href="{{url('superAdmin/')}}">
                                <img src="{{ asset('/public/images/Logo.png') }}" class="h-10 max-w-full" alt="Navbar Logo">
                            </a>
                        ...
                        <div class="hidden lg:flex lg:items-center lg:w-auto lg:space-x-6" id="top-navbar">
                            <ul class="flex flex-col lg:flex-row space-x-0 lg:space-x-2 list-none lg:ml-auto" id="navLinks">
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('superAdmin/view-home') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-home') }}">HOME</a>
                                </li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('superAdmin/view-guesthouse-rooms') || Request::is('superAdmin/view-staffhouse-rooms') || Request::is('superAdmin/view-dftc-rooms') || Request::is('superAdmin/view-dftc-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-guesthouse-rooms') }}">ROOMS</a>
                                </li>
                                <li class="lg:hidden"><hr class="dropdown-divider"></li>
                                <li class="nav-item">
                                    <a id="preBooBtn" class="btn btn-nav Montserrat {{ Request::is('superAdmin/view-guesthouse-form') || Request::is('superAdmin/view-staffhouse-form')  || Request::is('superAdmin/view-dftc-room-form') || Request::is('superAdmin/view-dftc-hall-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-guesthouse-form') }}">PRE-BOOK NOW</a>
                                </li>
                                <li class="nav-item">
                                    <a id="signOutButton" class="btn btn-nav Montserrat inactive">LOGOUT</a>
                                </li>
                            </ul>
                        </div>
                        <!-- User greetings on the right (outside toggle button)-->
                        <div class="hidden lg:flex lg:items-center text-end">
                            <a class="navbar-brand text-light-green Montserrat icon lg:text-lg font-medium hover:text-dark-green transition ease-in-out duration-500" href="{{ url('superAdminDashboard') }}">Hi, {{ session('loggedInSuperAdmin')['fullname'] }}<i class="fas fa-user fa-xl icon" style="color: #1abc02;"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="lg:hidden fixed top-0 right-0 bg-gradient-to-r from-light-white via-lightest-green to-lightest-green p-4 shadow-lg drop-shadow-lg rounded-bl-lg" id="mobileMenu" style="display: none;">
                        ...
                        <div class="flex flex-col flex-wrap px-2 mt-10">
                            <a class="navbar-brand text-light-green Montserrat icon text-lg font-medium hover:text-dark-green transition ease-in-out duration-500 mb-4 inline-block max-w-xs break-normal align-middle" href="{{ url('superAdminDashboard') }}">
                                Hi, {{ session('loggedInSuperAdmin')['fullname'] }}!
                            </a>
                            <ul class="flex flex-col justify-center text-center space-y-2 list-none w-full">
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('/superAdmin/view-home') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-home') }}"  style="width:100%">HOME</a>
                                </li>
                                <li class="nav-item">
                                    <a class="btn btn-nav Montserrat {{ Request::is('superAdmin/view-guesthouse-rooms') || Request::is('superAdmin/view-staffhouse-rooms') || Request::is('superAdmin/view-dftc-rooms') || Request::is('superAdmin/view-dftc-halls') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-guesthouse-rooms') }}"  style="width:100%">ROOMS</a>
                                </li>
                                <li><hr class="dropdown-divider bg-dark-green" style="height: 1px;"></li>
                                <li class="nav-item">
                                    <a id="preBooBtn" class="btn btn-nav Montserrat {{ Request::is('superAdmin/view-guesthouse-form') || Request::is('superAdmin/view-staffhouse-form')  || Request::is('superAdmin/view-dftc-room-form') || Request::is('superAdmin/view-dftc-hall-form') ? 'bg-light-green text-dark-white' : 'inactive' }}" href="{{ url('/superAdmin/view-guesthouse-form') }}"  style="width:100%">PRE-BOOK NOW</a>
                                </li>
                                <li class="nav-item">
                                    <a id="signOutButtonSmallerDevice" class="btn btn-nav Montserrat inactive" style="width:100%">LOGOUT</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container" data-aos="fade-right" data-aos-duration="800">
                <div class="row text-dark-white text-left">
                    ...
                    <div class="col-md-4 mb-6 md:mb-0">
                        ...
                        <p class="text-sm Montserrat footerText">Auxiliary Services Office, Nueva Vizcaya State University</p>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="background-color: #f5f5f5">
                            <div class="text-center">
                                <img class="rounded-circle shadow-1-strong mb-4 mx-auto" src="{{ asset('/public/images/developers/kristine.png') }}" width="120px" height="120px" alt="kristinephoto">
                                ...
                                <div class="d-flex justify-content-center mt-3">
                                    <a href="https://www.facebook.com/kj.briones20" target="_blank" class="mx-2">
                                        <img src="{{ asset('/public/images/fb.svg') }}" class="social-icon fb-icon" alt="Facebook">
                                    </a>
                                    <a href="mailto:kristinejoy.briones20@gmail.com" class="mx-2">
                                        <img src="{{ asset('/public/images/gmail.svg') }}" class="social-icon gmail-icon" alt="Gmail">
                                    </a>
                                    <a href="https://www.instagram.com/riexiel.b/" class="mx-2">
                                        <img src="{{ asset('/public/images/ig.svg') }}" class="social-icon ig-icon" alt="Instagram">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="background-color: #f5f5f5">
                            <div class="text-center">
                                <img class="rounded-circle shadow-1-strong mb-4 mx-auto" src="{{ asset('/public/images/developers/justin.png') }}" width="120px" height="120px" alt="justinphoto">
                        ...
                        <div class="carousel-item" style="background-color: #f5f5f5">
                            <div class="text-center">
                                <img class="rounded-circle shadow-1-strong mb-4 mx-auto" src="{{ asset('/public/images/developers/arjay.png') }}" width="120px" height="120px" alt="arjayphoto">
                        ...
                        <div class="carousel-item" style="background-color: #f5f5f5">
                            <div class="text-center">
                                <img class="rounded-circle shadow-1-strong mb-4 mx-auto" src="{{ asset('/public/images/developers/shammah.png') }}" width="120px" height="120px" alt="shammahphoto">
                        ...
                        <div class="carousel-item" style="background-color: #f5f5f5">
                            <div class="text-center">
                                <img class="rounded-circle shadow-1-strong mb-4 mx-auto" src="{{ asset('/public/images/developers/sirallen.png') }}" width="120px" height="120px" alt="shammahphoto">
...
<script src="{{ url('js/superadmin/logout.js') }}"></script>
<script src="{{ url('js/superadmin/rooms/functions.js') }}"></script>
<script src="{{ url('js/superadmin/guesthouse-booking/functions.js') }}"></script>
<script src="{{ url('js/superadmin/staffhouse-booking/functions.js') }}"></script>
<script src="{{ url('js/superadmin/dftc-booking/functions.js') }}"></script>
<script src="{{ url('js/superadmin/dftchall-booking/functions.js') }}"></script>
<script src="{{ url('js/superadmin/edit-guesthouse-booking/functions.js') }}"></script>
<script src="{{ url('js/superadmin/edit-staffhouse-booking/functions.js') }}"></script>
<script src="{{ url('js/superadmin/edit-dftc-room-booking/functions.js') }}"></script>
<script src="{{ url('js/superadmin/edit-dftc-hall-booking/functions.js') }}"></script>
<script src="{{ url('js/superadmin/client/functions.js') }}"></script>
<script src="{{ url('js/superadmin/account/functions.js') }}"></script>
<script src="{{ url('js/superadmin/pre-bookings/functions.js') }}"></script>
<script src="{{ url('js/superadmin/pdf/functions.js') }}"></script>
<script src="{{ url('js/superadmin/data-tables/functions.js') }}"></script>
