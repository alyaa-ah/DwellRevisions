...
<div class="outer-container">
    <div class="container flex-column d-flex justify-content-center align-items-center">
        ...
        <div class="row justify-content-center text-center" style="width:80%;" data-aos="fade-up" data-aos-duration="800">
            <p class="Montserrat font-extrabold textGradient text-center mt-2 text-3xl sm:text-4xl md:text-5xl lg:text-6xl h-12 sm:h-14 md:h-16 lg:h-20"">STAFF HOUSE</p>
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if(session()->has('loggedInCustomer') || session()->has('loggedInSuperAdmin') || session()->has('loggedInAdmin'))
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button onclick="viewStaffHousePreBookings('{{ $room->id }}')" class="mt-[1 rem] btn lg:rounded-full md:rounded bg-light-green text-white Montserrat hover:bg-dark-green transition ease-in-out duration-500 mr-2 flex items-center space-x-1">
                                            ...
                                            <button type="button" id="staffHouse-booking"
                                                onclick="bookStaffHouse('{{ addslashes(json_encode($room)) }}', '{{ addslashes(json_encode(session('loggedInSuperAdmin'))) }}')"
