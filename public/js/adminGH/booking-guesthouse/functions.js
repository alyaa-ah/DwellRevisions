...
function bookGuestHouse(room, user) {
    ...
    form.method = 'POST';
    form.action = '/adminGH/view-guesthouse-pre-reservation-form';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataAdminGH(roomNumber);
        });
    }
});
function fetchRoomDataAdminGH(roomNumber) {
    $.ajax({
        url: '/get-room-dataGuestHouseAdminGH',
        type: 'GET',
        data: {
