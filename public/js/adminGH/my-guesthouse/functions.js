...
function editGuestHouseBookingAdminGH(booking){
    var data = JSON.parse(booking);
...
function cancelGuestHouseBookingAdminGH(booking){
    var data = JSON.parse(booking);
...
$(document).ready(function() {
    ...
    $(document).on('click', '#submitButtonEditGuestHouse', function(event){
        ...
        $.ajax({
            ...
            url: '/adminGHEditBookingGuestHouse',
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $(document).on('submit', '#cancel-guesthouse-form', function(event){
        ...
        $.ajax({
            ...
            url: '/adminGHCancelBookingGuestHouse',
            method: 'POST',
            data: $(this).serialize(),
            success: function(response){
                if(response == 0){
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataEditGuestHouseAdminGH(roomNumber);
        });
    }
});

function fetchRoomDataEditGuestHouseAdminGH(roomNumber) {
    $.ajax({
        url: '/get-room-data-editAdminGH',
        type: 'GET',
        data: {
