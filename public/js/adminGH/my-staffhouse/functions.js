function viewStaffHouseBookingAdminGH(booking){
...
function editStaffHouseBookingAdminGH(booking){
    var data = JSON.parse(booking);
...
function cancelStaffHouseBookingAdminGH(booking){
    var data = JSON.parse(booking);
...
$(document).ready(function() {
    ...
    function editComputeTotalAmount() {
        ...
        if (isNaN(rate) || isNaN(capacity) || isNaN(numOfMale) || isNaN(numOfFemale)) {
            $('#editTotalAmountStaffHouse').val('NaN');
            return;
        }
    ...
    $(document).on('click', '#submitButtonEditStaffHouse', function(event){
        ...
        $.ajax({
            ...
            url: '/adminGHEditBookingStaffHouse',
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $(document).on('submit', '#cancel-staffhouse-form', function(event){
        ...
        $.ajax({
            ...
            url: '/adminGHCancelBookingStaffHouse',
            method: 'POST',
            data: $(this).serialize(),
            beforeSend: function() {
                Swal.fire({
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataEditStaffHouseAdminGH(roomNumber);
        });
    }
});
function fetchRoomDataEditStaffHouseAdminGH(roomNumber) {
    $.ajax({
        url: '/get-room-data-editStaffHouseAdminGH',
        type: 'GET',
        data: {
