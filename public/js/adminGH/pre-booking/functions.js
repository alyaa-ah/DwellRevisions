function viewGuestHousePreBookingsAdminGH(roomId) {
    $.ajax({
        url: '/get-guestHousePreBooking-detailsAdminGH',
        type: 'GET',
        data: { room_id: roomId },
...
function viewStaffHousePreBookingsAdminGH(roomId){
    $.ajax({
        url: '/get-staffHousePreBooking-detailsAdminGH',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
...
function viewDftcRoomPreBookingsAdminGH(roomId){
    $.ajax({
        url: '/get-dftcRoomPreBooking-detailsAdminGH',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
...
function viewDftcHallPreBookingsAdminGH(roomId){
    $.ajax({
        url: '/get-dftcHallPreBooking-detailsAdminGH',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
