function bookDftc(room, user) {
    ...
    form.method = 'POST';
    form.action = '/adminGH/view-DFTC-room-pre-reservation-form';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataDftcRoomAdminGH(roomNumber);

        });
    }
});
function fetchRoomDataDftcRoomAdminGH(roomNumber) {
    $.ajax({
        url: '/get-room-dataDftcRoomAdminGH',
        type: 'GET',
        data: {
