function bookDftc(room, user) {
    ...
    form.method = 'POST';
    form.action = '/adminDFTC/view-DFTC-room-pre-reservation-form';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataDftcRoomAdminDftc(roomNumber);

        });
    }
});
function fetchRoomDataDftcRoomAdminDftc(roomNumber) {
    $.ajax({
        url: '/get-room-dataDftcRoomAdminDftc',
        type: 'GET',
        data: {
