function viewGuestHousePreBookingsAdminDftc(roomId) {
    $.ajax({
        url: '/get-guestHousePreBooking-detailsAdminDftc',
        type: 'GET',
        data: { room_id: roomId },
...
function viewStaffHousePreBookingsAdminDftc(roomId){
    $.ajax({
        url: '/get-staffHousePreBooking-detailsAdminDftc',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
...
function viewDftcRoomPreBookingsAdminDftc(roomId){
    $.ajax({
        url: '/get-dftcRoomPreBooking-detailsAdminDftc',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
...
function viewDftcHallPreBookingsAdminDftc(roomId){
    $.ajax({
        url: '/get-dftcHallPreBooking-detailsAdminDftc',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
