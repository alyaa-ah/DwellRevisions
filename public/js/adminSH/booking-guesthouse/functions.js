...
function bookGuestHouse(room, user) {
    ...
    form.method = 'POST';
    form.action = '/adminSH/view-guesthouse-pre-reservation-form';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataAdminSH(roomNumber);
        });
    }
});
function fetchRoomDataAdminSH(roomNumber) {
    $.ajax({
        url: '/get-room-dataGuestHouseAdminSH',
        type: 'GET',
        data: {
