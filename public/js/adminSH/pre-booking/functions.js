function viewGuestHousePreBookingsAdminSH(roomId) {
    $.ajax({
        url: '/get-guestHousePreBooking-detailsAdminSH',
        type: 'GET',
        data: { room_id: roomId },
...
function viewStaffHousePreBookingsAdminSH(roomId){
    $.ajax({
        url: '/get-staffHousePreBooking-detailsAdminSH',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
...
function viewDftcRoomPreBookingsAdminSH(roomId){
    $.ajax({
        url: '/get-dftcRoomPreBooking-detailsAdminSH',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
...
function viewDftcHallPreBookingsAdminSH(roomId){
    $.ajax({
        url: '/get-dftcHallPreBooking-detailsAdminSH',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
