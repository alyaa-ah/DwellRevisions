function viewClientDftcHallBooking(booking){
    ...
    $('#janitorServices-modal').text(data.janitor_services);
    $('#avServices-modal').text(data.av_services);
    $('#view-DftcHall-modal').modal('show');
}
function editDftcHallBooking(booking){
    var data = JSON.parse(booking);
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataEditDftcHallClient(roomNumber);
        });
    }
});
function fetchRoomDataEditDftcHallClient(roomNumber) {

    $.ajax({
        url: '/get-room-dataEditDftcHallClient',
        type: 'GET',
        data: {
