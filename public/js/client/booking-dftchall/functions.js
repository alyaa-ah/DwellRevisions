function bookDftcHall(room, user) {
    ...
    form.method = 'POST';
    form.action = '/client/view-DFTC-hall-pre-reservation-form';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomData4(roomNumber);
        });
    }
});
function fetchRoomData4(roomNumber) {

    $.ajax({
        url: '/get-room-dataDftcHall',
        type: 'GET',
        data: {
