...
document.getElementById('editCheckInDateStaffHouse').addEventListener('change', function() {
    ...
    if (selectedCheckInDate) {
        ...
        const checkOutDateInput = document.getElementById('editCheckOutDateStaffHouse');
    ...
    document.getElementById('editCheckOutDateStaffHouse').addEventListener('change', function() {
        const selectedCheckOutDate = this.value;
        const checkInDate = document.getElementById('editCheckInDateStaffHouse').value;
    ...
    $(document).on('click', '#submitButtonEditStaffHouse', function(event){
        ...
        $.ajax({
            ...
            url: '/clientStaffHouseBookingEdit',
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $(document).on('submit', '#cancel-staffhouse-form', function(event){
        ...
        $.ajax({
            ...
            url: '/ClientCancelBookingStaffHouse',
            method: 'POST',
            data: $(this).serialize(),
            beforeSend: function() {
                Swal.fire({
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataEditStaffHouseClient(roomNumber);
        });
    }
});
function fetchRoomDataEditStaffHouseClient(roomNumber) {
    $.ajax({
        url: '/get-room-data-editStaffHouseClient',
        type: 'GET',
        data: {
