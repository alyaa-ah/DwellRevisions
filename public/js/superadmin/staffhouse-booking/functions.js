function bookStaffHouse(room, user) {
    ...
    form.method = 'POST';
    form.action = '/superAdmin/view-staffhouse-form';
...
$(document).ready(function() {
    ...
    $(document).on('click', '#submitButtonStaffHouse', function(event){
        ...
        $.ajax({
            ...
            url: '/superAdmin/staffHouse-booking',
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
            ...
            success: function(response){
                if(response == 0){
                    ...
                    showConfirmButton: true,
                        ...
                        window.location = "/superAdmin/view-staffhouse-preservations";
                    });
                }
            },
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataStaffHouse(roomNumber);
        });
    }
});
function fetchRoomDataStaffHouse(roomNumber) {

    $.ajax({
        url: '/superAdmin/staffHouse-get-room-data',
        type: 'GET',
        data: {
