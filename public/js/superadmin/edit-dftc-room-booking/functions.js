function viewDftcRoomBooking(booking){
...
$(document).ready(function() {
    ...
    $(document).on('click', '#submitButtonEditDftcRoom', function(event){
        ...
        $.ajax({
            ...
            url: '/superAdmin/updateDftcRoomBooking',
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $(document).on('submit', '#cancel-dftc-form', function(event){
        ...
        $.ajax({
            ...
            url: '/superAdmin/cancelDftcRoomBooking',
            method: 'POST',
            data: $(this).serialize(),
            beforeSend: function() {
                Swal.fire({
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataEditDftcRoom(roomNumber);
        });
    }
});
function fetchRoomDataEditDftcRoom(roomNumber) {
    $.ajax({
        url: '/superAdmin/editDftcRoom-get-room-data',
        type: 'GET',
        data: {
