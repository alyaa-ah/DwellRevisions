function viewDftcHallBooking(booking){
...
$(document).ready(function() {
    ...
    $(document).on('click', '#submitButtonEditDftcHall', function(event){
        ...
        $.ajax({
            ...
            url: '/superAdmin/updateDftcHallBooking',
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (roomNumberElement) {
        roomNumberElement.addEventListener("change", function() {
            ...
            fetchRoomDataEditDftcHall(roomNumber);
        });
    }
});
function fetchRoomDataEditDftcHall(roomNumber) {

    $.ajax({
        url: '/superAdmin/editDftcHall-get-room-data',
        type: 'GET',
        data: {
