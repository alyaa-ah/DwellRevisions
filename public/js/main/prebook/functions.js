function viewGuestHousePreBookingsMain(roomId) {
    $.ajax({
        url: '/get-guestHousePreBooking-detailsMain',
        type: 'GET',
        data: { room_id: roomId },
...
function viewStaffHousePreBookingsMain(roomId){
    $.ajax({
        url: '/get-staffHousePreBooking-detailsMain',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
...
function viewDftcRoomPreBookingsMain(roomId){
    $.ajax({
        url: '/get-dftcRoomPreBooking-detailsMain',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
...
function viewDftcHallPreBookingsMain(roomId){
    $.ajax({
        url: '/get-dftcHallPreBooking-detailsMain',
        type: 'GET',
        data: { room_id: roomId },
        success: function(response) {
            let bookingsArray = response.bookingsArray;
