...
class AdminGHBookingController extends Controller
{
    public function getGuestHousePreBookingDetailsAdminGH(Request $request) {
    ...
    public function getStaffHousePreBookingDetailsAdminGH(Request $request) {
        $roomId = $request->input('room_id');
    ...
    public function getDftcRoomPreBookingDetailsAdminGH(Request $request) {
        $roomId = $request->input('room_id');
    ...
    public function storeGuestHouseBookingAdminGH(Request $request){
    ...
    public function storeStaffHouseBookingAdminGH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeDftcRoomBookingAdminGH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeDftcHallBookingAdminGH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeEditGuestHouseBookingAdminGH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeEditStaffHouseBookingAdminGH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeEditDftcRoomBookingAdminGH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeEditDftcHallBookingAdminGH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function getGuestHousePendingBookings(){
