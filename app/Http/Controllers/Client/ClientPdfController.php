...
{
    public function generateClientGuestHouseBookingForm(Request $request){
        ...
        $pdf = PDF::loadView('client.pdf-form.guesthouse-booking', $data)
    ...
    public function generateClientStaffHouseBookingForm(Request $request){
        $bookingData = $request->json()->all();
        $headerHtml = '<div class="container-fluid">
             <div class="row">
                 <div class="col-md-12 d-flex justify-content-center">
        ...
        $pdf = PDF::loadView('client.pdf-form.staffhouse-booking', $data)
                 ->setPaper([0, 0, 612, 1056],)
                 ->setOptions([
                   'isHtml5ParserEnabled' => true,
                   'isRemoteEnabled' => true,
    ...
    public function generateClientDftcBookingClient(Request $request){
        $bookingData = $request->json()->all();
        $headerHtml = '<div class="container-fluid">
             <div class="row">
                 <div class="col-md-12 d-flex justify-content-center">
        ...
        $pdf = PDF::loadView('client.pdf-form.dftc-booking', $data)
                 ->setPaper([0, 0, 612, 1056],)
                 ->setOptions([
                   'isHtml5ParserEnabled' => true,
                   'isRemoteEnabled' => true,
