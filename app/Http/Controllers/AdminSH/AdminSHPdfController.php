...
class AdminSHPdfController extends Controller
{
    public function generateGuestHousePdfAdminGH(Request $request){
        ...
        $pdf = PDF::loadView('adminSH.pdf-form.guesthouse-booking', $data)
    ...
    public function generateStaffHousePdfAdminSH(Request $request){
        $bookingData = $request->json()->all();
        $headerHtml = '<div class="container-fluid">
             <div class="row">
                 <div class="col-md-12 d-flex justify-content-center">
        ...
        $pdf = PDF::loadView('adminSH.pdf-form.staffhouse-booking', $data)
                 ->setPaper([0, 0, 612, 1056],)
                 ->setOptions([
                   'isHtml5ParserEnabled' => true,
                   'isRemoteEnabled' => true,
    ...
    public function generateDftcBookingAdminSH(Request $request){
        $bookingData = $request->json()->all();
        $headerHtml = '<div class="container-fluid">
             <div class="row">
                 <div class="col-md-12 d-flex justify-content-center">
        ...
        $pdf = PDF::loadView('adminSH.pdf-form.dftc-booking', $data)
                 ->setPaper([0, 0, 612, 1056],)
                 ->setOptions([
                   'isHtml5ParserEnabled' => true,
                   'isRemoteEnabled' => true,
