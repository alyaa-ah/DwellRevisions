...
class AdminSHPreReservationController extends Controller
{
    public function goToAdminSHGuestHousePreReservation(){
        ...
        return view('adminSH.myPre-reservations.guesthouse.view-bookings', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function cancelGuestHouseBookingsAdminSH(Request $request){
    ...
    public function goToPreReservationStaffHouseAdminSH(){
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.staffhouse.view-bookings', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function cancelStaffHouseBookingsAdminSH(Request $request){
        ...
        return $bookingUpdated ? 1 : 0;
        (new AuditController)->createAuditTrail($fullname ,$clientId, $activity , $role);
    }
    public function goToDftcReservationAdminSH(){
        $client_id = session()->get('loggedInAdminSH')['id'];
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.DFTC.view-bookings' , ['bookings' => $bookings, 'rooms' => $rooms, 'countBookings' => $countBookings]);
    }
    public function cancelDftcBookingsAdminSH(Request $request){
    ...
    public function goToAdminSHGuestHouseHistory(){
        $facilityId = Facility::where('facility_name', 'Guest House')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get();
        $client_id = session()->get('loggedInAdminSH')['id'];
        $now = Carbon::now('Asia/Manila');
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.guesthouse.view-history', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function goToAdminSHStaffHouseHistory(){
        $facilityId = Facility::where('facility_name', 'Staff House')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get();
        $client_id = session()->get('loggedInAdminSH')['id'];
        $now = Carbon::now('Asia/Manila');
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.staffhouse.view-history', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function goToAdminSHDftcHistory(){
        $client_id = session()->get('loggedInAdminSH')['id'];
        $facilityId = Facility::where('facility_name', 'DFTC')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get()->keyBy('id');
        $now = Carbon::now('Asia/Manila');
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.DFTC.view-history', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function goToAdminSHCanceledBookingsGuestHouse() {
        $facilityId = Facility::where('facility_name', 'Guest House')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get();
        $client_id = session()->get('loggedInAdminSH')['id'];
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.guesthouse.view-cancellations', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function goToAdminSHRejectedBookingsGuestHouse() {
        $facilityId = Facility::where('facility_name', 'Guest House')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get();
        $client_id = session()->get('loggedInAdminSH')['id'];
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.guesthouse.view-rejections', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function goToAdminSHCanceledBookingsStaffHouse() {
        $facilityId = Facility::where('facility_name', 'Staff House')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get();
        $client_id = session()->get('loggedInAdminSH')['id'];
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.staffhouse.view-cancellations', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function goToAdminSHRejectedBookingsStaffHouse() {
        $facilityId = Facility::where('facility_name', 'Staff House')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get();
        $client_id = session()->get('loggedInAdminSH')['id'];
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.staffhouse.view-rejections', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function goToAdminSHCanceledBookingsDftc() {
        $facilityId = Facility::where('facility_name', 'Staff House')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get();
        $client_id = session()->get('loggedInAdminSH')['id'];
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.DFTC.view-cancellations', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
    }
    public function goToAdminSHRejectedBookingsDftc() {
        $facilityId = Facility::where('facility_name', 'Staff House')->value('id');
        $rooms = Room::where('facility_id', $facilityId)->get();
        $client_id = session()->get('loggedInAdminSH')['id'];
        ...
        $countBookings = count($bookings);
        return view('adminSH.myPre-reservations.DFTC.view-rejections', [
            'rooms' => $rooms,
            'bookings' => $bookings,
            'countBookings' => $countBookings,
        ]);
