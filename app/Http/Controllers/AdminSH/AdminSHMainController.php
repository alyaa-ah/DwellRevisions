...
class AdminSHMainController extends Controller
{
    ...
    public function goToGuestHouseRoomsAdminSH(){
        ...
        return view('adminSH.rooms.guestHouseRooms', ['guestHouseRooms' => $guestHouseRooms , 'bookings' => $bookings]);
    }
    public function goToStaffHouseRoomsAdminSH(){
        ...
        return view('adminSH.rooms.staffHouseRooms', ['staffHouseRooms' => $staffHouseRooms , 'bookings' => $bookings]);
    }
    public function goToDftcRoomsAdminSH(){
        ...
        return view('adminSH.rooms.dftcRooms', ['dftcRooms' => $dftcRooms , 'bookings' => $bookings]);
    }
    public function goToDftcHallsAdminSH(){
        ...
        return view('adminSH.rooms.dftcHalls', ['dftcHalls' => $dftcHalls , 'bookings' => $bookings]);
    }
