...
class AdminSHBookingController extends Controller
{
    public function getGuestHousePreBookingDetailsAdminSH(Request $request) {
    ...
    public function getStaffHousePreBookingDetailsAdminSH(Request $request) {
        $roomId = $request->input('room_id');
    ...
    public function getDftcRoomPreBookingDetailsAdminSH(Request $request) {
        $roomId = $request->input('room_id');
    ...
    public function storeGuestHouseBookingAdminSH(Request $request){
    ...
    public function storeStaffHouseBookingAdminSH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeDftcRoomBookingAdminSH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeDftcHallBookingAdminSH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
        ...
        if ($validator->fails()) {
            ...
            $fullname = session()->get('loggedInAdminSH')['fullname'];
            $role = session()->get('loggedInAdminSH')['role'];
            $activity = "Added a DFTC house pre-reservation in the system.";
            (new AuditController)->createAuditTrail($fullname ,$clientId, $activity , $role);
            return !is_null($dftcBooking) ? 1 : 0;
        }
    }
    public function storeEditGuestHouseBookingAdminSH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeEditStaffHouseBookingAdminSH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeEditDftcRoomBookingAdminSH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function storeEditDftcHallBookingAdminSH(Request $request){
        $validator = Validator::make($request->all(), [
            'fullname' => 'required|min:6|max:100',
            'position' => 'required',
            'agency' => 'required',
    ...
    public function getStaffHousePendingBookings(){
